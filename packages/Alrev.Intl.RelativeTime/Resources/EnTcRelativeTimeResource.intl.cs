...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Turks &amp; Caicos Islands)' [en-tc]
	/// </summary>
	public class EnTcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnTcRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-tc");
		}
	}
}