...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Nicaragua)' [es-ni]
	/// </summary>
	public class EsNiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsNiRelativeTimeResource()
