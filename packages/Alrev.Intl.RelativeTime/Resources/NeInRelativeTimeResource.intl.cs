...
{
	/// <summary>
	/// Relative Time Units resource for 'Nepali (India)' [ne-in]
	/// </summary>
	public class NeInRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NeInRelativeTimeResource()
