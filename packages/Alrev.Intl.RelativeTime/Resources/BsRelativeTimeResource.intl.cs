...
{
	/// <summary>
	/// Relative Time Units resource for 'Bosnian' [bs]
	/// </summary>
	public class BsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("bs");
		}
	}
}