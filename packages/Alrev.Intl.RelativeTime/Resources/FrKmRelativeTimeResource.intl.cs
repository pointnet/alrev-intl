...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Comoros)' [fr-km]
	/// </summary>
	public class FrKmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrKmRelativeTimeResource()
