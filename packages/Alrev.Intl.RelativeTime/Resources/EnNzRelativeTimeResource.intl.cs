...
{
	/// <summary>
	/// Relative Time Units resource for 'English (New Zealand)' [en-nz]
	/// </summary>
	public class EnNzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNzRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-nz");
		}
	}
}