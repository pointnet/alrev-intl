...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Eswatini)' [en-sz]
	/// </summary>
	public class EnSzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSzRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sz");
		}
	}
}