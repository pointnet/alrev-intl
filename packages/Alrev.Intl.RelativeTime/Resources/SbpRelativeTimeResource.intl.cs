...
{
	/// <summary>
	/// Relative Time Units resource for 'Sangu' [sbp]
	/// </summary>
	public class SbpRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SbpRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("sbp");
		}
	}
}