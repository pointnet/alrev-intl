...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Vanuatu)' [en-vu]
	/// </summary>
	public class EnVuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnVuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-vu");
		}
	}
}