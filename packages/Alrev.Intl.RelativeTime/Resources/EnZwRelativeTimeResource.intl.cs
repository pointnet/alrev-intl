...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Zimbabwe)' [en-zw]
	/// </summary>
	public class EnZwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnZwRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-zw");
		}
	}
}