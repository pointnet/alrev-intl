...
{
	/// <summary>
	/// Relative Time Units resource for 'Kamba' [kam]
	/// </summary>
	public class KamRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KamRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("kam");
		}
	}
}