...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Finland)' [en-fi]
	/// </summary>
	public class EnFiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnFiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-fi");
		}
	}
}