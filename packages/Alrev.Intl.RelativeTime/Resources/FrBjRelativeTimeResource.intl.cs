...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Benin)' [fr-bj]
	/// </summary>
	public class FrBjRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrBjRelativeTimeResource()
