...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Sweden)' [en-se]
	/// </summary>
	public class EnSeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-se");
		}
	}
}