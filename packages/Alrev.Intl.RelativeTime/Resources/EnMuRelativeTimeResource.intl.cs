...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Mauritius)' [en-mu]
	/// </summary>
	public class EnMuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mu");
		}
	}
}