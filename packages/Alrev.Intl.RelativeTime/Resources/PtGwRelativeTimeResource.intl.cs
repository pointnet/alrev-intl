...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Guinea-Bissau)' [pt-gw]
	/// </summary>
	public class PtGwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtGwRelativeTimeResource()
