...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Peru)' [es-pe]
	/// </summary>
	public class EsPeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsPeRelativeTimeResource()
