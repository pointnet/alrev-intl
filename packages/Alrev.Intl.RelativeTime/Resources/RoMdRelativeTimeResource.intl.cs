...
{
	/// <summary>
	/// Relative Time Units resource for 'Romanian (Moldova)' [ro-md]
	/// </summary>
	public class RoMdRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public RoMdRelativeTimeResource()
