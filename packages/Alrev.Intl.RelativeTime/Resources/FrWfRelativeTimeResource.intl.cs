...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Wallis &amp; Futuna)' [fr-wf]
	/// </summary>
	public class FrWfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrWfRelativeTimeResource()
