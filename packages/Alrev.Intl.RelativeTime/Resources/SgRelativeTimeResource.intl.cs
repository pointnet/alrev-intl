...
{
	/// <summary>
	/// Relative Time Units resource for 'Sango' [sg]
	/// </summary>
	public class SgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
