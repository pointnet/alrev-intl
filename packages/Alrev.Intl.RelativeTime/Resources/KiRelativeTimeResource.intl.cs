...
{
	/// <summary>
	/// Relative Time Units resource for 'Kikuyu' [ki]
	/// </summary>
	public class KiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("ki");
		}
	}
}