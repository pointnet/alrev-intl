...
{
	/// <summary>
	/// Relative Time Units resource for 'English (World)' [en-001]
	/// </summary>
	public class En001RelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public En001RelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-001");
		}
	}
}