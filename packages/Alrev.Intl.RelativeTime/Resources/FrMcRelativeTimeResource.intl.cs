...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Monaco)' [fr-mc]
	/// </summary>
	public class FrMcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMcRelativeTimeResource()
