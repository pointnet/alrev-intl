...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Antigua &amp; Barbuda)' [en-ag]
	/// </summary>
	public class EnAgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnAgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ag");
		}
	}
}