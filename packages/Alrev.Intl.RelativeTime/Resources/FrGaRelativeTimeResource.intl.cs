...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Gabon)' [fr-ga]
	/// </summary>
	public class FrGaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrGaRelativeTimeResource()
