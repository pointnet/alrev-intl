...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Mauritania)' [fr-mr]
	/// </summary>
	public class FrMrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMrRelativeTimeResource()
