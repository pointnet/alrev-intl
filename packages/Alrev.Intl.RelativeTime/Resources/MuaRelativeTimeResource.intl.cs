...
{
	/// <summary>
	/// Relative Time Units resource for 'Mundang' [mua]
	/// </summary>
	public class MuaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MuaRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("mua");
		}
	}
}