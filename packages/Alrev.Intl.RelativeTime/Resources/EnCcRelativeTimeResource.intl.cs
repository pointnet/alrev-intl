...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Cocos [Keeling] Islands)' [en-cc]
	/// </summary>
	public class EnCcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnCcRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-cc");
		}
	}
}