...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Mauritius)' [fr-mu]
	/// </summary>
	public class FrMuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMuRelativeTimeResource()
