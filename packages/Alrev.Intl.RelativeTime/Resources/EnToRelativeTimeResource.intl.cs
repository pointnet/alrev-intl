...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Tonga)' [en-to]
	/// </summary>
	public class EnToRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnToRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-to");
		}
	}
}