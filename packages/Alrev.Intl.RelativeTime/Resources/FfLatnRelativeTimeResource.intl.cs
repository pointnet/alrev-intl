...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah' [ff-latn]
	/// </summary>
	public class FfLatnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn");
		}
	}
}