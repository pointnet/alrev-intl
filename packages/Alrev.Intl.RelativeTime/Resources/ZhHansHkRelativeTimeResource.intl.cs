...
{
	/// <summary>
	/// Relative Time Units resource for 'Chinese (Simplified, Hong Kong SAR)' [zh-hans-hk]
	/// </summary>
	public class ZhHansHkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public ZhHansHkRelativeTimeResource()
