...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Northern Mariana Islands)' [en-mp]
	/// </summary>
	public class EnMpRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMpRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mp");
		}
	}
}