...
{
	/// <summary>
	/// Relative Time Units resource for 'Kinyarwanda' [rw]
	/// </summary>
	public class RwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("rw");
		}
	}
}