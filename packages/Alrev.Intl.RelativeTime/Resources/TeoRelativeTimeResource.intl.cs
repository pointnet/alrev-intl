...
{
	/// <summary>
	/// Relative Time Units resource for 'Teso' [teo]
	/// </summary>
	public class TeoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public TeoRelativeTimeResource()
