...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Algeria)' [fr-dz]
	/// </summary>
	public class FrDzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrDzRelativeTimeResource()
