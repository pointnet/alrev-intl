...
{
	/// <summary>
	/// Relative Time Units resource for 'Esperanto' [eo]
	/// </summary>
	public class EoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
