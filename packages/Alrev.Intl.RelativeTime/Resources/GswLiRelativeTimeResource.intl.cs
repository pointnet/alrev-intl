...
{
	/// <summary>
	/// Relative Time Units resource for 'Swiss German (Liechtenstein)' [gsw-li]
	/// </summary>
	public class GswLiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public GswLiRelativeTimeResource()
