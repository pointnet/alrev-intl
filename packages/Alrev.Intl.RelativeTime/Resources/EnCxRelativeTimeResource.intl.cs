...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Christmas Island)' [en-cx]
	/// </summary>
	public class EnCxRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnCxRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-cx");
		}
	}
}