...
{
	/// <summary>
	/// Relative Time Units resource for 'English (St. Kitts &amp; Nevis)' [en-kn]
	/// </summary>
	public class EnKnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnKnRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-kn");
		}
	}
}