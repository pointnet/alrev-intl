...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Ghana)' [ff-latn-gh]
	/// </summary>
	public class FfLatnGhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnGhRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-gh");
		}
	}
}