...
{
	/// <summary>
	/// Relative Time Units resource for 'Somali (Kenya)' [so-ke]
	/// </summary>
	public class SoKeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SoKeRelativeTimeResource()
