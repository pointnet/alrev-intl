...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Burundi)' [en-bi]
	/// </summary>
	public class EnBiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-bi");
		}
	}
}