...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Pakistan)' [en-pk]
	/// </summary>
	public class EnPkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPkRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-pk");
		}
	}
}