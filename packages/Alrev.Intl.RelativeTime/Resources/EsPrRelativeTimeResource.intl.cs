...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Puerto Rico)' [es-pr]
	/// </summary>
	public class EsPrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsPrRelativeTimeResource()
