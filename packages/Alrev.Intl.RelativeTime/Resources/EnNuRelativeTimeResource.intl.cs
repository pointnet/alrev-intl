...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Niue)' [en-nu]
	/// </summary>
	public class EnNuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-nu");
		}
	}
}