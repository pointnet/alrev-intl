...
{
	/// <summary>
	/// Relative Time Units resource for 'Basaa' [bas]
	/// </summary>
	public class BasRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public BasRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("bas");
		}
	}
}