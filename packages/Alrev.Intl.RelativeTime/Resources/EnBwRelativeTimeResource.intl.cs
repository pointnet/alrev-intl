...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Botswana)' [en-bw]
	/// </summary>
	public class EnBwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBwRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-bw");
		}
	}
}