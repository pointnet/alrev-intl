...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Martinique)' [fr-mq]
	/// </summary>
	public class FrMqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMqRelativeTimeResource()
