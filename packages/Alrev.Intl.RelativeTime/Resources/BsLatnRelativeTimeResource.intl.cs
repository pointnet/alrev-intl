...
{
	/// <summary>
	/// Relative Time Units resource for 'Bosnian' [bs-latn]
	/// </summary>
	public class BsLatnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public BsLatnRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("bs-latn");
		}
	}
}