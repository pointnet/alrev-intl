...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Europe)' [en-150]
	/// </summary>
	public class En150RelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public En150RelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-150");
		}
	}
}