...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Jersey)' [en-je]
	/// </summary>
	public class EnJeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnJeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-je");
		}
	}
}