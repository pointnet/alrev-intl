...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Seychelles)' [en-sc]
	/// </summary>
	public class EnScRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnScRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sc");
		}
	}
}