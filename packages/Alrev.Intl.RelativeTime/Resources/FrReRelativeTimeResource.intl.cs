...
{
	/// <summary>
	/// Relative Time Units resource for 'French (R&#233;union)' [fr-re]
	/// </summary>
	public class FrReRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrReRelativeTimeResource()
