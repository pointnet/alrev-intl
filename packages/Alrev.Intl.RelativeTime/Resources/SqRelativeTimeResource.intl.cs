...
{
	/// <summary>
	/// Relative Time Units resource for 'Albanian' [sq]
	/// </summary>
	public class SqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
