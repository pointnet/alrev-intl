...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Madagascar)' [en-mg]
	/// </summary>
	public class EnMgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mg");
		}
	}
}