...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Senegal)' [fr-sn]
	/// </summary>
	public class FrSnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrSnRelativeTimeResource()
