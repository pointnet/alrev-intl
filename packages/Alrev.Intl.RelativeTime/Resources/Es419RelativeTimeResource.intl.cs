...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Latin America)' [es-419]
	/// </summary>
	public class Es419RelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public Es419RelativeTimeResource()
