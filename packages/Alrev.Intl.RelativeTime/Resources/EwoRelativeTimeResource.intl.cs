...
{
	/// <summary>
	/// Relative Time Units resource for 'Ewondo' [ewo]
	/// </summary>
	public class EwoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EwoRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ewo");
		}
	}
}