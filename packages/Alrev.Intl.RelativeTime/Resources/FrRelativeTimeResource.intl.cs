...
{
	/// <summary>
	/// Relative Time Units resource for 'French' [fr]
	/// </summary>
	public class FrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
