...
{
	/// <summary>
	/// Relative Time Units resource for 'Punjabi' [pa]
	/// </summary>
	public class PaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
