...
{
	/// <summary>
	/// Relative Time Units resource for 'Afrikaans (Namibia)' [af-na]
	/// </summary>
	public class AfNaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public AfNaRelativeTimeResource()
