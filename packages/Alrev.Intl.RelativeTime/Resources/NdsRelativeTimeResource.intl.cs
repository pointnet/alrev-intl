...
{
	/// <summary>
	/// Relative Time Units resource for 'Low German' [nds]
	/// </summary>
	public class NdsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NdsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("nds");
		}
	}
}