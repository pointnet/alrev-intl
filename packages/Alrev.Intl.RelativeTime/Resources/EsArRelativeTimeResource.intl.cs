...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Argentina)' [es-ar]
	/// </summary>
	public class EsArRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsArRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("es-ar");
		}
	}
}