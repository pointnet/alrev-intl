...
{
	/// <summary>
	/// Relative Time Units resource for 'Lingala (Congo)' [ln-cg]
	/// </summary>
	public class LnCgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LnCgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ln-cg");
		}
	}
}