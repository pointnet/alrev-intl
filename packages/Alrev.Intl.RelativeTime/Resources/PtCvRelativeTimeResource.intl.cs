...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Cabo Verde)' [pt-cv]
	/// </summary>
	public class PtCvRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtCvRelativeTimeResource()
