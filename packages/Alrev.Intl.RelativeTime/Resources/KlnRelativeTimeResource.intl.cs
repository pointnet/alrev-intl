...
{
	/// <summary>
	/// Relative Time Units resource for 'Kalenjin' [kln]
	/// </summary>
	public class KlnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KlnRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("kln");
		}
	}
}