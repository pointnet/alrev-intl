...
{
	/// <summary>
	/// Relative Time Units resource for 'Koyra Chiini' [khq]
	/// </summary>
	public class KhqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KhqRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("khq");
		}
	}
}