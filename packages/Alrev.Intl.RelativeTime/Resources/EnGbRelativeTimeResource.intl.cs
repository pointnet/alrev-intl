...
{
	/// <summary>
	/// Relative Time Units resource for 'English (United Kingdom)' [en-gb]
	/// </summary>
	public class EnGbRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGbRelativeTimeResource()
