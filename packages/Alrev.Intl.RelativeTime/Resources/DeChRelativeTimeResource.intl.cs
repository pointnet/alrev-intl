...
{
	/// <summary>
	/// Relative Time Units resource for 'German (Switzerland)' [de-ch]
	/// </summary>
	public class DeChRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DeChRelativeTimeResource()
