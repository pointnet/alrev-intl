...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Kenya)' [en-ke]
	/// </summary>
	public class EnKeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnKeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ke");
		}
	}
}