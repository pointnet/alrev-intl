...
{
	/// <summary>
	/// Relative Time Units resource for 'North Ndebele' [nd]
	/// </summary>
	public class NdRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
