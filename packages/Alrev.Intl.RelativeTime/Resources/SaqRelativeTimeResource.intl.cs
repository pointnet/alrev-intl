...
{
	/// <summary>
	/// Relative Time Units resource for 'Samburu' [saq]
	/// </summary>
	public class SaqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SaqRelativeTimeResource()
