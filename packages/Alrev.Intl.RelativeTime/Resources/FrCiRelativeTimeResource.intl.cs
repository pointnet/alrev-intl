...
{
	/// <summary>
	/// Relative Time Units resource for 'French (C&#244;te d&#8217;Ivoire)' [fr-ci]
	/// </summary>
	public class FrCiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrCiRelativeTimeResource()
