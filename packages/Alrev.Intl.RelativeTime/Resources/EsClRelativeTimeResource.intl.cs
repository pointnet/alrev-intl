...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Chile)' [es-cl]
	/// </summary>
	public class EsClRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsClRelativeTimeResource()
