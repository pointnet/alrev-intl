...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Paraguay)' [es-py]
	/// </summary>
	public class EsPyRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsPyRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("es-py");
		}
	}
}