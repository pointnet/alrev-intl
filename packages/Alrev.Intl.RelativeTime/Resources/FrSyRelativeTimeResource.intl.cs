...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Syria)' [fr-sy]
	/// </summary>
	public class FrSyRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrSyRelativeTimeResource()
