...
{
	/// <summary>
	/// Relative Time Units resource for 'Nama' [naq]
	/// </summary>
	public class NaqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NaqRelativeTimeResource()
