...
{
	/// <summary>
	/// Relative Time Units resource for 'Tachelhit' [shi-latn]
	/// </summary>
	public class ShiLatnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public ShiLatnRelativeTimeResource()
						...
						{
							{
								IntlStyleValues.Long,
								new RelativeTimeResource(
									new Dictionary<int, string> { { -1, "iḍlli" }, { 0, "assa" }, { 1, "askka" } },
		...
		{
			this.Culture = new CultureInfo("shi-latn");
		}
	}
}