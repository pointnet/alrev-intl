...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Tokelau)' [en-tk]
	/// </summary>
	public class EnTkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnTkRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-tk");
		}
	}
}