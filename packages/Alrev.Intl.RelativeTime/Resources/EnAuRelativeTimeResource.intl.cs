...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Australia)' [en-au]
	/// </summary>
	public class EnAuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnAuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-au");
		}
	}
}