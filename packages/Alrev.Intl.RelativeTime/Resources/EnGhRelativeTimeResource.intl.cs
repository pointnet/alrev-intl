...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Ghana)' [en-gh]
	/// </summary>
	public class EnGhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGhRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gh");
		}
	}
}