...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Samoa)' [en-ws]
	/// </summary>
	public class EnWsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnWsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ws");
		}
	}
}