...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Luxembourg)' [pt-lu]
	/// </summary>
	public class PtLuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtLuRelativeTimeResource()
