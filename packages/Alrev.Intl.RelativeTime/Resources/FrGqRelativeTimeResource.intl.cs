...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Equatorial Guinea)' [fr-gq]
	/// </summary>
	public class FrGqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrGqRelativeTimeResource()
