...
{
	/// <summary>
	/// Relative Time Units resource for 'Punjabi' [pa-arab]
	/// </summary>
	public class PaArabRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PaArabRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("pa-arab");
		}
	}
}