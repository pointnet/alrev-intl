...
{
	/// <summary>
	/// Relative Time Units resource for 'Tachelhit' [shi-tfng]
	/// </summary>
	public class ShiTfngRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public ShiTfngRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("shi-tfng");
		}
	}
}