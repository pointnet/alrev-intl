...
{
	/// <summary>
	/// Relative Time Units resource for 'Cornish' [kw]
	/// </summary>
	public class KwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
