...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Falkland Islands)' [en-fk]
	/// </summary>
	public class EnFkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnFkRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-fk");
		}
	}
}