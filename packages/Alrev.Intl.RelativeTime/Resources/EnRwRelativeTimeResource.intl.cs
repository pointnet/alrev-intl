...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Rwanda)' [en-rw]
	/// </summary>
	public class EnRwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnRwRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-rw");
		}
	}
}