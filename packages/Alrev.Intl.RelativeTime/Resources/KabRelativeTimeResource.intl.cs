...
{
	/// <summary>
	/// Relative Time Units resource for 'Kabyle' [kab]
	/// </summary>
	public class KabRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KabRelativeTimeResource()
