...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Switzerland)' [fr-ch]
	/// </summary>
	public class FrChRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrChRelativeTimeResource()
