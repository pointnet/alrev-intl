...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Isle of Man)' [en-im]
	/// </summary>
	public class EnImRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnImRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-im");
		}
	}
}