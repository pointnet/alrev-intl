...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (United States)' [es-us]
	/// </summary>
	public class EsUsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsUsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("es-us");
		}
	}
}