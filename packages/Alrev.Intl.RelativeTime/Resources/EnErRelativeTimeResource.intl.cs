...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Eritrea)' [en-er]
	/// </summary>
	public class EnErRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnErRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-er");
		}
	}
}