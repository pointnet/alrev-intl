...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Anguilla)' [en-ai]
	/// </summary>
	public class EnAiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnAiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ai");
		}
	}
}