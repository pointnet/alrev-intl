...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Dominica)' [en-dm]
	/// </summary>
	public class EnDmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnDmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-dm");
		}
	}
}