...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Honduras)' [es-hn]
	/// </summary>
	public class EsHnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsHnRelativeTimeResource()
