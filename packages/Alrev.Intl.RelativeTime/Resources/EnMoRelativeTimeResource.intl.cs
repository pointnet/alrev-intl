...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Macao SAR)' [en-mo]
	/// </summary>
	public class EnMoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMoRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mo");
		}
	}
}