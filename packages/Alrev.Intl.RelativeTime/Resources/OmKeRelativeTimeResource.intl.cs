...
{
	/// <summary>
	/// Relative Time Units resource for 'Oromo (Kenya)' [om-ke]
	/// </summary>
	public class OmKeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public OmKeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("om-ke");
		}
	}
}