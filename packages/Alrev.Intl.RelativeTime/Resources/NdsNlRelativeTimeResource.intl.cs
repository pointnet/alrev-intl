...
{
	/// <summary>
	/// Relative Time Units resource for 'Low German (Netherlands)' [nds-nl]
	/// </summary>
	public class NdsNlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NdsNlRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("nds-nl");
		}
	}
}