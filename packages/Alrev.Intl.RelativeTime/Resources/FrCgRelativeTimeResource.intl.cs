...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Congo)' [fr-cg]
	/// </summary>
	public class FrCgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrCgRelativeTimeResource()
