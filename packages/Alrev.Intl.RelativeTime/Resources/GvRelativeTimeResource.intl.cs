...
{
	/// <summary>
	/// Relative Time Units resource for 'Manx' [gv]
	/// </summary>
	public class GvRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
