...
{
	/// <summary>
	/// Relative Time Units resource for 'Russian (Moldova)' [ru-md]
	/// </summary>
	public class RuMdRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public RuMdRelativeTimeResource()
