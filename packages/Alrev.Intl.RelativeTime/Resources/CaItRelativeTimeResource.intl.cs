...
{
	/// <summary>
	/// Relative Time Units resource for 'Catalan (Italy)' [ca-it]
	/// </summary>
	public class CaItRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public CaItRelativeTimeResource()
