...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Mexico)' [es-mx]
	/// </summary>
	public class EsMxRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsMxRelativeTimeResource()
