...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Malaysia)' [en-my]
	/// </summary>
	public class EnMyRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMyRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-my");
		}
	}
}