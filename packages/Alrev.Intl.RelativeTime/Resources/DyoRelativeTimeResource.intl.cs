...
{
	/// <summary>
	/// Relative Time Units resource for 'Jola-Fonyi' [dyo]
	/// </summary>
	public class DyoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DyoRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("dyo");
		}
	}
}