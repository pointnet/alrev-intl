...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Papua New Guinea)' [en-pg]
	/// </summary>
	public class EnPgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-pg");
		}
	}
}