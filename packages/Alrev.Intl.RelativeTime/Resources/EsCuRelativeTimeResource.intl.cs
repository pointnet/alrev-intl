...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Cuba)' [es-cu]
	/// </summary>
	public class EsCuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsCuRelativeTimeResource()
