...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Togo)' [fr-tg]
	/// </summary>
	public class FrTgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrTgRelativeTimeResource()
