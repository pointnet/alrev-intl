...
{
	/// <summary>
	/// Relative Time Units resource for 'German (Luxembourg)' [de-lu]
	/// </summary>
	public class DeLuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DeLuRelativeTimeResource()
