...
{
	/// <summary>
	/// Relative Time Units resource for 'Shambala' [ksb]
	/// </summary>
	public class KsbRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KsbRelativeTimeResource()
