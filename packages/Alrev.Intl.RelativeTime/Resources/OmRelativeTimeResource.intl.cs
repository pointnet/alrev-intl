...
{
	/// <summary>
	/// Relative Time Units resource for 'Oromo' [om]
	/// </summary>
	public class OmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
