...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Macao SAR)' [pt-mo]
	/// </summary>
	public class PtMoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtMoRelativeTimeResource()
