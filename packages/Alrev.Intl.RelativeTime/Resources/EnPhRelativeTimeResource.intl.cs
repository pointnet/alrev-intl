...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Philippines)' [en-ph]
	/// </summary>
	public class EnPhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPhRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ph");
		}
	}
}