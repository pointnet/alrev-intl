...
{
	/// <summary>
	/// Relative Time Units resource for 'Russian' [ru]
	/// </summary>
	public class RuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
