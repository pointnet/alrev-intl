...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Malawi)' [en-mw]
	/// </summary>
	public class EnMwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMwRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mw");
		}
	}
}