...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Cook Islands)' [en-ck]
	/// </summary>
	public class EnCkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnCkRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ck");
		}
	}
}