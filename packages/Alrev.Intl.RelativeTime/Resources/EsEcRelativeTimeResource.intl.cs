...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Ecuador)' [es-ec]
	/// </summary>
	public class EsEcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsEcRelativeTimeResource()
