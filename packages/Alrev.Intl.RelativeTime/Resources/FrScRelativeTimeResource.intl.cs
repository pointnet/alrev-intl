...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Seychelles)' [fr-sc]
	/// </summary>
	public class FrScRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrScRelativeTimeResource()
