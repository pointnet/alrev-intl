...
{
	/// <summary>
	/// Relative Time Units resource for 'Vai' [vai]
	/// </summary>
	public class VaiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public VaiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("vai");
		}
	}
}