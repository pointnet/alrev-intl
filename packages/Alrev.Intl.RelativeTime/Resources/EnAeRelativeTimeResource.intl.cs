...
{
	/// <summary>
	/// Relative Time Units resource for 'English (United Arab Emirates)' [en-ae]
	/// </summary>
	public class EnAeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnAeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ae");
		}
	}
}