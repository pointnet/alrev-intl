...
{
	/// <summary>
	/// Relative Time Units resource for 'English (American Samoa)' [en-as]
	/// </summary>
	public class EnAsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnAsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-as");
		}
	}
}