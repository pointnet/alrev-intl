...
{
	/// <summary>
	/// Relative Time Units resource for 'Cebuano' [ceb]
	/// </summary>
	public class CebRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public CebRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ceb");
		}
	}
}