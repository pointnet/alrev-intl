...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Canada)' [fr-ca]
	/// </summary>
	public class FrCaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrCaRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("fr-ca");
		}
	}
}