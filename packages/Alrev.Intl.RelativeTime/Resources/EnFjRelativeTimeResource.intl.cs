...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Fiji)' [en-fj]
	/// </summary>
	public class EnFjRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnFjRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-fj");
		}
	}
}