...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Marshall Islands)' [en-mh]
	/// </summary>
	public class EnMhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMhRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mh");
		}
	}
}