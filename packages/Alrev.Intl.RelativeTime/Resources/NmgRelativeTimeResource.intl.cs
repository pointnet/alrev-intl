...
{
	/// <summary>
	/// Relative Time Units resource for 'Kwasio' [nmg]
	/// </summary>
	public class NmgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NmgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("nmg");
		}
	}
}