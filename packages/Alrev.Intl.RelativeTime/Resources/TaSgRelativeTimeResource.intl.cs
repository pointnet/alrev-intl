...
{
	/// <summary>
	/// Relative Time Units resource for 'Tamil (Singapore)' [ta-sg]
	/// </summary>
	public class TaSgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public TaSgRelativeTimeResource()
