...
{
	/// <summary>
	/// Relative Time Units resource for 'English (India)' [en-in]
	/// </summary>
	public class EnInRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnInRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-in");
		}
	}
}