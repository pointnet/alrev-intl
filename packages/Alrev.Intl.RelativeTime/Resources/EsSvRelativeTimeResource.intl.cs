...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (El Salvador)' [es-sv]
	/// </summary>
	public class EsSvRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsSvRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("es-sv");
		}
	}
}