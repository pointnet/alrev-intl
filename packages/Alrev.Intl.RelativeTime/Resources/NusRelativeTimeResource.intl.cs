...
{
	/// <summary>
	/// Relative Time Units resource for 'Nuer' [nus]
	/// </summary>
	public class NusRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NusRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("nus");
		}
	}
}