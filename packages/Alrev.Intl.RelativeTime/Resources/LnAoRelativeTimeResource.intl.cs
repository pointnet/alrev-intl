...
{
	/// <summary>
	/// Relative Time Units resource for 'Lingala (Angola)' [ln-ao]
	/// </summary>
	public class LnAoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LnAoRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ln-ao");
		}
	}
}