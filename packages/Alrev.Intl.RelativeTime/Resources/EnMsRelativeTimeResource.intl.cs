...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Montserrat)' [en-ms]
	/// </summary>
	public class EnMsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ms");
		}
	}
}