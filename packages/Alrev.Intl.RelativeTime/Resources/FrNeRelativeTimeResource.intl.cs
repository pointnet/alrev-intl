...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Niger)' [fr-ne]
	/// </summary>
	public class FrNeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrNeRelativeTimeResource()
