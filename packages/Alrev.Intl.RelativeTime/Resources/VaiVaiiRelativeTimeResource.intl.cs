...
{
	/// <summary>
	/// Relative Time Units resource for 'Vai' [vai-vaii]
	/// </summary>
	public class VaiVaiiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public VaiVaiiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("vai-vaii");
		}
	}
}