...
{
	/// <summary>
	/// Relative Time Units resource for 'Swiss German (France)' [gsw-fr]
	/// </summary>
	public class GswFrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public GswFrRelativeTimeResource()
