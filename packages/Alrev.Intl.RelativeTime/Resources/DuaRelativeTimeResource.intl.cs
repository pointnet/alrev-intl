...
{
	/// <summary>
	/// Relative Time Units resource for 'Duala' [dua]
	/// </summary>
	public class DuaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DuaRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("dua");
		}
	}
}