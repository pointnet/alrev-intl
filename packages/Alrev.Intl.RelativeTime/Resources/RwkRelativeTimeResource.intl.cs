...
{
	/// <summary>
	/// Relative Time Units resource for 'Rwa' [rwk]
	/// </summary>
	public class RwkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public RwkRelativeTimeResource()
