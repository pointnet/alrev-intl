...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Guadeloupe)' [fr-gp]
	/// </summary>
	public class FrGpRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrGpRelativeTimeResource()
