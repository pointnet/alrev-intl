...
{
	/// <summary>
	/// Relative Time Units resource for 'Sanskrit' [sa]
	/// </summary>
	public class SaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("sa");
		}
	}
}