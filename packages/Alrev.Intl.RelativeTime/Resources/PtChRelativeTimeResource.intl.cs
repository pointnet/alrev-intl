...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Switzerland)' [pt-ch]
	/// </summary>
	public class PtChRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtChRelativeTimeResource()
