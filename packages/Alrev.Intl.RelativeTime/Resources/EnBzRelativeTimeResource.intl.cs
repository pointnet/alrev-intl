...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Belize)' [en-bz]
	/// </summary>
	public class EnBzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBzRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-bz");
		}
	}
}