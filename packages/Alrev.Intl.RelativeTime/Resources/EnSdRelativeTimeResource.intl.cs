...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Sudan)' [en-sd]
	/// </summary>
	public class EnSdRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSdRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sd");
		}
	}
}