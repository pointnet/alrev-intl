...
{
	/// <summary>
	/// Relative Time Units resource for 'Malagasy' [mg]
	/// </summary>
	public class MgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
