...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Switzerland)' [en-ch]
	/// </summary>
	public class EnChRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnChRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ch");
		}
	}
}