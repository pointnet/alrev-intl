...
{
	/// <summary>
	/// Relative Time Units resource for 'French (New Caledonia)' [fr-nc]
	/// </summary>
	public class FrNcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrNcRelativeTimeResource()
