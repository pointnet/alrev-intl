...
{
	/// <summary>
	/// Relative Time Units resource for 'Tamil' [ta]
	/// </summary>
	public class TaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
