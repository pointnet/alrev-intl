...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Morocco)' [fr-ma]
	/// </summary>
	public class FrMaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMaRelativeTimeResource()
