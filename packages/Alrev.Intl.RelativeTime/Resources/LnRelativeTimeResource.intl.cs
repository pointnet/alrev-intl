...
{
	/// <summary>
	/// Relative Time Units resource for 'Lingala' [ln]
	/// </summary>
	public class LnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
