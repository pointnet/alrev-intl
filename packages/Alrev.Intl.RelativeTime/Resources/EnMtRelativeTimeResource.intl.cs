...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Malta)' [en-mt]
	/// </summary>
	public class EnMtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnMtRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-mt");
		}
	}
}