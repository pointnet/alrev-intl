...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Gibraltar)' [en-gi]
	/// </summary>
	public class EnGiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gi");
		}
	}
}