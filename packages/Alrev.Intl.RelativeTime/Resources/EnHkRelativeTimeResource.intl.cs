...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Hong Kong SAR)' [en-hk]
	/// </summary>
	public class EnHkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnHkRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-hk");
		}
	}
}