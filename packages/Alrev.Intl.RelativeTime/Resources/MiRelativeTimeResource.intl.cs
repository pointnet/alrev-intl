...
{
	/// <summary>
	/// Relative Time Units resource for 'Maori' [mi]
	/// </summary>
	public class MiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("mi");
		}
	}
}