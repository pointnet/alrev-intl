...
{
	/// <summary>
	/// Relative Time Units resource for 'Northern Luri (Iraq)' [lrc-iq]
	/// </summary>
	public class LrcIqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LrcIqRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("lrc-iq");
		}
	}
}