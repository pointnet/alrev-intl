...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Germany)' [en-de]
	/// </summary>
	public class EnDeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnDeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-de");
		}
	}
}