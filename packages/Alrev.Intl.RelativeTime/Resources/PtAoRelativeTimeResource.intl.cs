...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Angola)' [pt-ao]
	/// </summary>
	public class PtAoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtAoRelativeTimeResource()
