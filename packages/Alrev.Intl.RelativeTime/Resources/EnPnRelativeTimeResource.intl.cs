...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Pitcairn Islands)' [en-pn]
	/// </summary>
	public class EnPnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPnRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-pn");
		}
	}
}