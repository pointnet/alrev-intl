...
{
	/// <summary>
	/// Relative Time Units resource for 'Chinese' [zh]
	/// </summary>
	public class ZhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("zh");
		}
	}
}