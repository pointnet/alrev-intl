...
{
	/// <summary>
	/// Relative Time Units resource for 'Catalan' [ca]
	/// </summary>
	public class CaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
