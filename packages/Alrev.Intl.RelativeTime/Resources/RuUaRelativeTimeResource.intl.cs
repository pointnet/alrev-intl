...
{
	/// <summary>
	/// Relative Time Units resource for 'Russian (Ukraine)' [ru-ua]
	/// </summary>
	public class RuUaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public RuUaRelativeTimeResource()
