...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Nigeria)' [ff-latn-ng]
	/// </summary>
	public class FfLatnNgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnNgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-ng");
		}
	}
}