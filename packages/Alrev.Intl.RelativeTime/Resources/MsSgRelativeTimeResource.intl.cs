...
{
	/// <summary>
	/// Relative Time Units resource for 'Malay (Singapore)' [ms-sg]
	/// </summary>
	public class MsSgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MsSgRelativeTimeResource()
