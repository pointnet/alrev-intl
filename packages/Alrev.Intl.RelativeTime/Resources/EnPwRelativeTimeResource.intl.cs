...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Palau)' [en-pw]
	/// </summary>
	public class EnPwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPwRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-pw");
		}
	}
}