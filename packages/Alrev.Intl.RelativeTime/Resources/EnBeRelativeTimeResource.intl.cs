...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Belgium)' [en-be]
	/// </summary>
	public class EnBeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-be");
		}
	}
}