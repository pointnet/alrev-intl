...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Burundi)' [fr-bi]
	/// </summary>
	public class FrBiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrBiRelativeTimeResource()
