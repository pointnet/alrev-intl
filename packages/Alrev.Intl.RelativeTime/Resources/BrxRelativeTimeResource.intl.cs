...
{
	/// <summary>
	/// Relative Time Units resource for 'Bodo' [brx]
	/// </summary>
	public class BrxRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public BrxRelativeTimeResource()
