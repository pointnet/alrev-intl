...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Gambia)' [en-gm]
	/// </summary>
	public class EnGmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gm");
		}
	}
}