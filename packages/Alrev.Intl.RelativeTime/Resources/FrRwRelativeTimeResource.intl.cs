...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Rwanda)' [fr-rw]
	/// </summary>
	public class FrRwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrRwRelativeTimeResource()
