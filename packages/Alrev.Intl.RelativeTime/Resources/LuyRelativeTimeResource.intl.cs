...
{
	/// <summary>
	/// Relative Time Units resource for 'Luyia' [luy]
	/// </summary>
	public class LuyRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LuyRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("luy");
		}
	}
}