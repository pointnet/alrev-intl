...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Equatorial Guinea)' [es-gq]
	/// </summary>
	public class EsGqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsGqRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("es-gq");
		}
	}
}