...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Namibia)' [en-na]
	/// </summary>
	public class EnNaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNaRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-na");
		}
	}
}