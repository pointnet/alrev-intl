...
{
	/// <summary>
	/// Relative Time Units resource for 'English (St. Vincent &amp; Grenadines)' [en-vc]
	/// </summary>
	public class EnVcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnVcRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-vc");
		}
	}
}