...
{
	/// <summary>
	/// Relative Time Units resource for 'Makhuwa-Meetto' [mgh]
	/// </summary>
	public class MghRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MghRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("mgh");
		}
	}
}