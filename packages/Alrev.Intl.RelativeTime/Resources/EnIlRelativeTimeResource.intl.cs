...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Israel)' [en-il]
	/// </summary>
	public class EnIlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnIlRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-il");
		}
	}
}