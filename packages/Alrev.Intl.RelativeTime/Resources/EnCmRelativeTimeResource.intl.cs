...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Cameroon)' [en-cm]
	/// </summary>
	public class EnCmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnCmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-cm");
		}
	}
}