...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Singapore)' [en-sg]
	/// </summary>
	public class EnSgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sg");
		}
	}
}