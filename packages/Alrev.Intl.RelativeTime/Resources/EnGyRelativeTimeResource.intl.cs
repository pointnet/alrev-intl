...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Guyana)' [en-gy]
	/// </summary>
	public class EnGyRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGyRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gy");
		}
	}
}