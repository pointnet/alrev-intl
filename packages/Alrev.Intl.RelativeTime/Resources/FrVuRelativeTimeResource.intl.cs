...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Vanuatu)' [fr-vu]
	/// </summary>
	public class FrVuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrVuRelativeTimeResource()
