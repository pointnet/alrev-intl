...
{
	/// <summary>
	/// Relative Time Units resource for 'Ngiemboon' [nnh]
	/// </summary>
	public class NnhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NnhRelativeTimeResource()
