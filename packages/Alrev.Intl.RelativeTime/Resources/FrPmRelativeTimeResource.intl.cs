...
{
	/// <summary>
	/// Relative Time Units resource for 'French (St. Pierre &amp; Miquelon)' [fr-pm]
	/// </summary>
	public class FrPmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrPmRelativeTimeResource()
