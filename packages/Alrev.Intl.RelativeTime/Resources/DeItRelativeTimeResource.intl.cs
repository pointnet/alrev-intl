...
{
	/// <summary>
	/// Relative Time Units resource for 'German (Italy)' [de-it]
	/// </summary>
	public class DeItRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DeItRelativeTimeResource()
