...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Slovenia)' [en-si]
	/// </summary>
	public class EnSiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSiRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-si");
		}
	}
}