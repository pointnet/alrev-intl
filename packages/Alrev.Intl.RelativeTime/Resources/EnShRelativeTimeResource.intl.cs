...
{
	/// <summary>
	/// Relative Time Units resource for 'English (St Helena, Ascension, Tristan da Cunha)' [en-sh]
	/// </summary>
	public class EnShRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnShRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sh");
		}
	}
}