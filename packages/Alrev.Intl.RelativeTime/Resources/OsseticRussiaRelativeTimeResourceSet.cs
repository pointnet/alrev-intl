    ...
    public class OsseticRussiaRelativeTimeResourceSet : IRelativeTimeResourceSet, IResource
    {
        ...
        public IRelativeTimeStylesResource Day { get; } = new RelativeTimeStylesResource(
            ...
            new RelativeTimeResource(
                ...
                "Абон",
                "Сом",
                new RelativeTimeCountResource("{0} бон раздӕр", "{0} боны размӕ"),
                new RelativeTimeCountResource("{0} боны фӕстӕ", "{0} боны фӕстӕ")),
            new RelativeTimeResource(
                LOCALE,
                RelativeTimeTypeValues.Narrow,
                "Бон",
        ...
        public IRelativeTimeStylesResource Hour { get; } = new RelativeTimeStylesResource(
            ...
            new RelativeTimeResource(
                ...
                "this hour",
                null,
                new RelativeTimeCountResource("{0} сахаты размӕ", "{0} сахаты размӕ"),
                new RelativeTimeCountResource("{0} сахаты фӕстӕ", "{0} сахаты фӕстӕ")),
            new RelativeTimeResource(
                LOCALE,
                RelativeTimeTypeValues.Narrow,
                "Сахат",
