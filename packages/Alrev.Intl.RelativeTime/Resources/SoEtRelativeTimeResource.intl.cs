...
{
	/// <summary>
	/// Relative Time Units resource for 'Somali (Ethiopia)' [so-et]
	/// </summary>
	public class SoEtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SoEtRelativeTimeResource()
