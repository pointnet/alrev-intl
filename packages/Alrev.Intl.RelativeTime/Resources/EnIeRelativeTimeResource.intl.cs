...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Ireland)' [en-ie]
	/// </summary>
	public class EnIeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnIeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ie");
		}
	}
}