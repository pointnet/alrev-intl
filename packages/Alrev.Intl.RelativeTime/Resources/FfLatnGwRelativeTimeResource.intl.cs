...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Guinea-Bissau)' [ff-latn-gw]
	/// </summary>
	public class FfLatnGwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnGwRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-gw");
		}
	}
}