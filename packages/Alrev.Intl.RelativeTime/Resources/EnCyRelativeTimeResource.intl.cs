...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Cyprus)' [en-cy]
	/// </summary>
	public class EnCyRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnCyRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-cy");
		}
	}
}