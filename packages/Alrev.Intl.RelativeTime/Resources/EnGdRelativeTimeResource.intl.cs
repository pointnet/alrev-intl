...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Grenada)' [en-gd]
	/// </summary>
	public class EnGdRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGdRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gd");
		}
	}
}