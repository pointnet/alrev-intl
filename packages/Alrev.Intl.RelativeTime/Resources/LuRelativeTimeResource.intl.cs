...
{
	/// <summary>
	/// Relative Time Units resource for 'Luba-Katanga' [lu]
	/// </summary>
	public class LuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("lu");
		}
	}
}