...
{
	/// <summary>
	/// Relative Time Units resource for 'Teso (Kenya)' [teo-ke]
	/// </summary>
	public class TeoKeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public TeoKeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("teo-ke");
		}
	}
}