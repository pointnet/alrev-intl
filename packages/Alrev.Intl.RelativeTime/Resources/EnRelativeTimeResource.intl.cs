...
{
	/// <summary>
	/// Relative Time Units resource for 'English' [en]
	/// </summary>
	public class EnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
