...
{
	/// <summary>
	/// Relative Time Units resource for 'Northern Luri' [lrc]
	/// </summary>
	public class LrcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LrcRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("lrc");
		}
	}
}