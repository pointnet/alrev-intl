...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Liberia)' [en-lr]
	/// </summary>
	public class EnLrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnLrRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-lr");
		}
	}
}