...
{
	/// <summary>
	/// Relative Time Units resource for 'English (U.S. Virgin Islands)' [en-vi]
	/// </summary>
	public class EnViRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnViRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-vi");
		}
	}
}