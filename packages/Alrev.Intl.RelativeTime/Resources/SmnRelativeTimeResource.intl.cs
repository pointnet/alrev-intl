...
{
	/// <summary>
	/// Relative Time Units resource for 'Inari Sami' [smn]
	/// </summary>
	public class SmnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SmnRelativeTimeResource()
