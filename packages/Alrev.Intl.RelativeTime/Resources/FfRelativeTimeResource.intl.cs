...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah' [ff]
	/// </summary>
	public class FfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
