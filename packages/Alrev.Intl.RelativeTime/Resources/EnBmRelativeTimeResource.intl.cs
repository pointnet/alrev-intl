...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Bermuda)' [en-bm]
	/// </summary>
	public class EnBmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-bm");
		}
	}
}