...
{
	/// <summary>
	/// Relative Time Units resource for 'Meta&#700;' [mgo]
	/// </summary>
	public class MgoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MgoRelativeTimeResource()
