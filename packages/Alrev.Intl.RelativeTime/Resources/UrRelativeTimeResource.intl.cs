...
{
	/// <summary>
	/// Relative Time Units resource for 'Urdu' [ur]
	/// </summary>
	public class UrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("ur");
		}
	}
}