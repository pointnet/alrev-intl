...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Norfolk Island)' [en-nf]
	/// </summary>
	public class EnNfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNfRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-nf");
		}
	}
}