...
{
	/// <summary>
	/// Relative Time Units resource for 'Akan' [ak]
	/// </summary>
	public class AkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
