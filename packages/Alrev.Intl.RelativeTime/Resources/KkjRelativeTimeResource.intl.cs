...
{
	/// <summary>
	/// Relative Time Units resource for 'Kako' [kkj]
	/// </summary>
	public class KkjRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KkjRelativeTimeResource()
