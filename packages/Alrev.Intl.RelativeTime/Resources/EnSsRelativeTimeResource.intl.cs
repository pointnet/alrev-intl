...
{
	/// <summary>
	/// Relative Time Units resource for 'English (South Sudan)' [en-ss]
	/// </summary>
	public class EnSsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ss");
		}
	}
}