...
{
	/// <summary>
	/// Relative Time Units resource for 'Bamanankan' [bm]
	/// </summary>
	public class BmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
