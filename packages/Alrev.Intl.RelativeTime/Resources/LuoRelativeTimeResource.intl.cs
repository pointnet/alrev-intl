...
{
	/// <summary>
	/// Relative Time Units resource for 'Luo' [luo]
	/// </summary>
	public class LuoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LuoRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("luo");
		}
	}
}