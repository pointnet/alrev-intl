...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Austria)' [en-at]
	/// </summary>
	public class EnAtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnAtRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-at");
		}
	}
}