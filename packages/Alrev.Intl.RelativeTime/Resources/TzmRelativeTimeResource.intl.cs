...
{
	/// <summary>
	/// Relative Time Units resource for 'Central Atlas Tamazight' [tzm]
	/// </summary>
	public class TzmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public TzmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("tzm");
		}
	}
}