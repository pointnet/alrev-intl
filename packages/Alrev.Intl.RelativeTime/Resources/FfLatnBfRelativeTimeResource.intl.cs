...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Burkina Faso)' [ff-latn-bf]
	/// </summary>
	public class FfLatnBfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnBfRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-bf");
		}
	}
}