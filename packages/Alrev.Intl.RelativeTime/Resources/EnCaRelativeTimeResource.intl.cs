...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Canada)' [en-ca]
	/// </summary>
	public class EnCaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnCaRelativeTimeResource()
