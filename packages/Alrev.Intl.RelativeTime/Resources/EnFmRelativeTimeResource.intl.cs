...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Micronesia)' [en-fm]
	/// </summary>
	public class EnFmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnFmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-fm");
		}
	}
}