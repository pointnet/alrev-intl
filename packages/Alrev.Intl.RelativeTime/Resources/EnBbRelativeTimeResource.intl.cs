...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Barbados)' [en-bb]
	/// </summary>
	public class EnBbRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBbRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-bb");
		}
	}
}