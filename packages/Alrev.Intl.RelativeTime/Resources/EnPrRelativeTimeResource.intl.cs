...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Puerto Rico)' [en-pr]
	/// </summary>
	public class EnPrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPrRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-pr");
		}
	}
}