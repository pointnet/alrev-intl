...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Niger)' [ff-latn-ne]
	/// </summary>
	public class FfLatnNeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnNeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-ne");
		}
	}
}