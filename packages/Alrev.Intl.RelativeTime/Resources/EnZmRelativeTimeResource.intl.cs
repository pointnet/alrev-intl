...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Zambia)' [en-zm]
	/// </summary>
	public class EnZmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnZmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-zm");
		}
	}
}