...
{
	/// <summary>
	/// Relative Time Units resource for 'Norwegian Bokm&#229;l' [nb]
	/// </summary>
	public class NbRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
