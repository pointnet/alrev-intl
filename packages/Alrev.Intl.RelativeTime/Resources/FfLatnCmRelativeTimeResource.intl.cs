...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Cameroon)' [ff-latn-cm]
	/// </summary>
	public class FfLatnCmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnCmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-cm");
		}
	}
}