...
{
	/// <summary>
	/// Relative Time Units resource for 'English (South Africa)' [en-za]
	/// </summary>
	public class EnZaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnZaRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-za");
		}
	}
}