...
{
	/// <summary>
	/// Relative Time Units resource for 'Vai' [vai-latn]
	/// </summary>
	public class VaiLatnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public VaiLatnRelativeTimeResource()
						...
						{
							{
								IntlStyleValues.Long,
								new RelativeTimeResource(
									new Dictionary<int, string> { { -1, "kunu" }, { 0, "wɛlɛ" }, { 1, "sina" } },
		...
		{
			this.Culture = new CultureInfo("vai-latn");
		}
	}
}