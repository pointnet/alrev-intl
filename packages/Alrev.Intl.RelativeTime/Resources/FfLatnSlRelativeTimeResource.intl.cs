...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Sierra Leone)' [ff-latn-sl]
	/// </summary>
	public class FfLatnSlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnSlRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-sl");
		}
	}
}