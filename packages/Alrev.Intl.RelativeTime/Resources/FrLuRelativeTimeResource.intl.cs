...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Luxembourg)' [fr-lu]
	/// </summary>
	public class FrLuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrLuRelativeTimeResource()
