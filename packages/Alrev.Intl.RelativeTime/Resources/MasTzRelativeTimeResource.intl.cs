...
{
	/// <summary>
	/// Relative Time Units resource for 'Masai (Tanzania)' [mas-tz]
	/// </summary>
	public class MasTzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MasTzRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("mas-tz");
		}
	}
}