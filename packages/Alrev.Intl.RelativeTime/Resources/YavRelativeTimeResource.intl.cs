...
{
	/// <summary>
	/// Relative Time Units resource for 'Yangben' [yav]
	/// </summary>
	public class YavRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public YavRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("yav");
		}
	}
}