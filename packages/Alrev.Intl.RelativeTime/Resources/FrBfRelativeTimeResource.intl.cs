...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Burkina Faso)' [fr-bf]
	/// </summary>
	public class FrBfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrBfRelativeTimeResource()
