...
{
	/// <summary>
	/// Relative Time Units resource for 'Ossetic (Russia)' [os-ru]
	/// </summary>
	public class OsRuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public OsRuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("os-ru");
		}
	}
}