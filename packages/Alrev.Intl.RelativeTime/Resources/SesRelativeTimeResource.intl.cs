...
{
	/// <summary>
	/// Relative Time Units resource for 'Koyraboro Senni' [ses]
	/// </summary>
	public class SesRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SesRelativeTimeResource()
