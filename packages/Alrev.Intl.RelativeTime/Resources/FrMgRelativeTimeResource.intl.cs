...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Madagascar)' [fr-mg]
	/// </summary>
	public class FrMgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMgRelativeTimeResource()
