...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Nigeria)' [en-ng]
	/// </summary>
	public class EnNgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ng");
		}
	}
}