...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Haiti)' [fr-ht]
	/// </summary>
	public class FrHtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrHtRelativeTimeResource()
