...
{
	/// <summary>
	/// Relative Time Units resource for 'Meru' [mer]
	/// </summary>
	public class MerRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MerRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("mer");
		}
	}
}