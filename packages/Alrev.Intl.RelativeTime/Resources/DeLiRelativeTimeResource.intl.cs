...
{
	/// <summary>
	/// Relative Time Units resource for 'German (Liechtenstein)' [de-li]
	/// </summary>
	public class DeLiRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DeLiRelativeTimeResource()
