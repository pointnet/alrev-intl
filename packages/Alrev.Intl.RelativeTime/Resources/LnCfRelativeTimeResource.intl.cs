...
{
	/// <summary>
	/// Relative Time Units resource for 'Lingala (Central African Republic)' [ln-cf]
	/// </summary>
	public class LnCfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LnCfRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ln-cf");
		}
	}
}