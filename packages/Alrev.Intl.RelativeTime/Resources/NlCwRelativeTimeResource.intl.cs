...
{
	/// <summary>
	/// Relative Time Units resource for 'Dutch (Cura&#231;ao)' [nl-cw]
	/// </summary>
	public class NlCwRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public NlCwRelativeTimeResource()
