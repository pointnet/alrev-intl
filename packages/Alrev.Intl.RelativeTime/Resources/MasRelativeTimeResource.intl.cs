...
{
	/// <summary>
	/// Relative Time Units resource for 'Masai' [mas]
	/// </summary>
	public class MasRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MasRelativeTimeResource()
