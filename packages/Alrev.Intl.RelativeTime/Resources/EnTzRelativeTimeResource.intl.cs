...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Tanzania)' [en-tz]
	/// </summary>
	public class EnTzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnTzRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-tz");
		}
	}
}