...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Netherlands)' [en-nl]
	/// </summary>
	public class EnNlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNlRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-nl");
		}
	}
}