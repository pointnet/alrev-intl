...
{
	/// <summary>
	/// Relative Time Units resource for 'Azerbaijani' [az-cyrl]
	/// </summary>
	public class AzCyrlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public AzCyrlRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("az-cyrl");
		}
	}
}