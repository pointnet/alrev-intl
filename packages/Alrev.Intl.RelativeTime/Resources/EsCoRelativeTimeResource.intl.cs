...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Colombia)' [es-co]
	/// </summary>
	public class EsCoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsCoRelativeTimeResource()
