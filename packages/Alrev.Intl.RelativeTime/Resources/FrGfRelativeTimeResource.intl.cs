...
{
	/// <summary>
	/// Relative Time Units resource for 'French (French Guiana)' [fr-gf]
	/// </summary>
	public class FrGfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrGfRelativeTimeResource()
