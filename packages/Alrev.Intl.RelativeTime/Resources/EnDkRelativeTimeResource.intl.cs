...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Denmark)' [en-dk]
	/// </summary>
	public class EnDkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnDkRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-dk");
		}
	}
}