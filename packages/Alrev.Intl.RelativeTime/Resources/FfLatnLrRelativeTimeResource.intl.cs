...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Liberia)' [ff-latn-lr]
	/// </summary>
	public class FfLatnLrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnLrRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-lr");
		}
	}
}