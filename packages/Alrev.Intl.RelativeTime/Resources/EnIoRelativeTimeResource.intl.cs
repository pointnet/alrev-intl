...
{
	/// <summary>
	/// Relative Time Units resource for 'English (British Indian Ocean Territory)' [en-io]
	/// </summary>
	public class EnIoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnIoRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-io");
		}
	}
}