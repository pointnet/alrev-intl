...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Mayotte)' [fr-yt]
	/// </summary>
	public class FrYtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrYtRelativeTimeResource()
