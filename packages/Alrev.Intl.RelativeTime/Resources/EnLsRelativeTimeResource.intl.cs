...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Lesotho)' [en-ls]
	/// </summary>
	public class EnLsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnLsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-ls");
		}
	}
}