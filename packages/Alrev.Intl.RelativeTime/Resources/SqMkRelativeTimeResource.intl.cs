...
{
	/// <summary>
	/// Relative Time Units resource for 'Albanian (North Macedonia)' [sq-mk]
	/// </summary>
	public class SqMkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SqMkRelativeTimeResource()
