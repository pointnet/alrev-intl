...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Chad)' [fr-td]
	/// </summary>
	public class FrTdRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrTdRelativeTimeResource()
