...
{
	/// <summary>
	/// Relative Time Units resource for 'Tasawaq' [twq]
	/// </summary>
	public class TwqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public TwqRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("twq");
		}
	}
}