...
{
	/// <summary>
	/// Relative Time Units resource for 'Aghem' [agq]
	/// </summary>
	public class AgqRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public AgqRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("agq");
		}
	}
}