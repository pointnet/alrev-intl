...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Tuvalu)' [en-tv]
	/// </summary>
	public class EnTvRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnTvRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-tv");
		}
	}
}