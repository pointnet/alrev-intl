...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Solomon Islands)' [en-sb]
	/// </summary>
	public class EnSbRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSbRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sb");
		}
	}
}