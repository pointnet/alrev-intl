...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Trinidad &amp; Tobago)' [en-tt]
	/// </summary>
	public class EnTtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnTtRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-tt");
		}
	}
}