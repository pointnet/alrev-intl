...
{
	/// <summary>
	/// Relative Time Units resource for 'Hawaiian' [haw]
	/// </summary>
	public class HawRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public HawRelativeTimeResource()
