...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Djibouti)' [fr-dj]
	/// </summary>
	public class FrDjRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrDjRelativeTimeResource()
