...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Guernsey)' [en-gg]
	/// </summary>
	public class EnGgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gg");
		}
	}
}