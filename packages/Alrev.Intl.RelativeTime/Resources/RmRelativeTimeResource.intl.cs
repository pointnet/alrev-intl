...
{
	/// <summary>
	/// Relative Time Units resource for 'Romansh' [rm]
	/// </summary>
	public class RmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
