...
{
	/// <summary>
	/// Relative Time Units resource for 'Standard Moroccan Tamazight' [zgh]
	/// </summary>
	public class ZghRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public ZghRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("zgh");
		}
	}
}