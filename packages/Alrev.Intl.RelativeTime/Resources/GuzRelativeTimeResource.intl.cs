...
{
	/// <summary>
	/// Relative Time Units resource for 'Gusii' [guz]
	/// </summary>
	public class GuzRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public GuzRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("guz");
		}
	}
}