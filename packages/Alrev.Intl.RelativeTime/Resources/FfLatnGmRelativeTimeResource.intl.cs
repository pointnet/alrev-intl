...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Gambia)' [ff-latn-gm]
	/// </summary>
	public class FfLatnGmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnGmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-gm");
		}
	}
}