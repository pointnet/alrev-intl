...
{
	/// <summary>
	/// Relative Time Units resource for 'Tibetan (India)' [bo-in]
	/// </summary>
	public class BoInRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public BoInRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("bo-in");
		}
	}
}