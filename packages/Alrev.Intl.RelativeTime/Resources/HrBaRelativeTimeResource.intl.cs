...
{
	/// <summary>
	/// Relative Time Units resource for 'Croatian (Bosnia &amp; Herzegovina)' [hr-ba]
	/// </summary>
	public class HrBaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public HrBaRelativeTimeResource()
