...
{
	/// <summary>
	/// Relative Time Units resource for 'Bemba' [bem]
	/// </summary>
	public class BemRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public BemRelativeTimeResource()
