...
{
	/// <summary>
	/// Relative Time Units resource for 'English (United States, Computer)' [en-us-posix]
	/// </summary>
	public class EnUsPosixRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnUsPosixRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-us-posix");
		}
	}
}