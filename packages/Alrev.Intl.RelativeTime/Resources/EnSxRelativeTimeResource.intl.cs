...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Sint Maarten)' [en-sx]
	/// </summary>
	public class EnSxRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSxRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-sx");
		}
	}
}