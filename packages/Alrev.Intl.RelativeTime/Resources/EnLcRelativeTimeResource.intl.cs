...
{
	/// <summary>
	/// Relative Time Units resource for 'English (St. Lucia)' [en-lc]
	/// </summary>
	public class EnLcRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnLcRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-lc");
		}
	}
}