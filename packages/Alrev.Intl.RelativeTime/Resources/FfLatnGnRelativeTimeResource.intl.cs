...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Guinea)' [ff-latn-gn]
	/// </summary>
	public class FfLatnGnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnGnRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-gn");
		}
	}
}