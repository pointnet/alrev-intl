...
{
	/// <summary>
	/// Relative Time Units resource for 'Bafia' [ksf]
	/// </summary>
	public class KsfRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public KsfRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ksf");
		}
	}
}