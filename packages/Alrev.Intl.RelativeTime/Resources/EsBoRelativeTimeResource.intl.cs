...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Bolivia)' [es-bo]
	/// </summary>
	public class EsBoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsBoRelativeTimeResource()
