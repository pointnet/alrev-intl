...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish' [es]
	/// </summary>
	public class EsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("es");
		}
	}
}