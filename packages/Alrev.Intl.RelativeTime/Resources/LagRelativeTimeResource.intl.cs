...
{
	/// <summary>
	/// Relative Time Units resource for 'Langi' [lag]
	/// </summary>
	public class LagRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public LagRelativeTimeResource()
