...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Sierra Leone)' [en-sl]
	/// </summary>
	public class EnSlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnSlRelativeTimeResource()
