...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Panama)' [es-pa]
	/// </summary>
	public class EsPaRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsPaRelativeTimeResource()
