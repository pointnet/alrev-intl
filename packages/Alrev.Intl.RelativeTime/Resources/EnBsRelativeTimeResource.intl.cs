...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Bahamas)' [en-bs]
	/// </summary>
	public class EnBsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnBsRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-bs");
		}
	}
}