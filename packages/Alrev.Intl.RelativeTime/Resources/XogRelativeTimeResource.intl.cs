...
{
	/// <summary>
	/// Relative Time Units resource for 'Soga' [xog]
	/// </summary>
	public class XogRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public XogRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("xog");
		}
	}
}