...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Jamaica)' [en-jm]
	/// </summary>
	public class EnJmRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnJmRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-jm");
		}
	}
}