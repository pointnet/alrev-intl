...
{
	/// <summary>
	/// Relative Time Units resource for 'Fulah (Latin, Mauritania)' [ff-latn-mr]
	/// </summary>
	public class FfLatnMrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FfLatnMrRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ff-latn-mr");
		}
	}
}