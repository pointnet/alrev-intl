...
{
	/// <summary>
	/// Relative Time Units resource for 'Somali (Djibouti)' [so-dj]
	/// </summary>
	public class SoDjRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SoDjRelativeTimeResource()
