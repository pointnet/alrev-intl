...
{
	/// <summary>
	/// Relative Time Units resource for 'French (Mali)' [fr-ml]
	/// </summary>
	public class FrMlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public FrMlRelativeTimeResource()
