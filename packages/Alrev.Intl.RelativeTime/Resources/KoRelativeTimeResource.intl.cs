...
{
	/// <summary>
	/// Relative Time Units resource for 'Korean' [ko]
	/// </summary>
	public class KoRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
