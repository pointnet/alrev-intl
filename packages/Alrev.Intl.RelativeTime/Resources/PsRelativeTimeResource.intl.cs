...
{
	/// <summary>
	/// Relative Time Units resource for 'Pashto' [ps]
	/// </summary>
	public class PsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("ps");
		}
	}
}