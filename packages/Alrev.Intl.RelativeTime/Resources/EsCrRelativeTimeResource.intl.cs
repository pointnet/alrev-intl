...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Costa Rica)' [es-cr]
	/// </summary>
	public class EsCrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsCrRelativeTimeResource()
