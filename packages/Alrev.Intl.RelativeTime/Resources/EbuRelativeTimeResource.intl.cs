...
{
	/// <summary>
	/// Relative Time Units resource for 'Embu' [ebu]
	/// </summary>
	public class EbuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EbuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("ebu");
		}
	}
}