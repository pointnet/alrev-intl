...
{
	/// <summary>
	/// Relative Time Units resource for 'Serbian' [sr-latn]
	/// </summary>
	public class SrLatnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public SrLatnRelativeTimeResource()
