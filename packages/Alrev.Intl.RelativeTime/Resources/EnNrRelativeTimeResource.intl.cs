...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Nauru)' [en-nr]
	/// </summary>
	public class EnNrRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnNrRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-nr");
		}
	}
}