...
{
	/// <summary>
	/// Relative Time Units resource for 'Ganda' [lg]
	/// </summary>
	public class LgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
