...
{
	/// <summary>
	/// Relative Time Units resource for 'Portuguese (Timor-Leste)' [pt-tl]
	/// </summary>
	public class PtTlRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public PtTlRelativeTimeResource()
