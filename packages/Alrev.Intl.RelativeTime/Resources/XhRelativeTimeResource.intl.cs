...
{
	/// <summary>
	/// Relative Time Units resource for 'isiXhosa' [xh]
	/// </summary>
	public class XhRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
