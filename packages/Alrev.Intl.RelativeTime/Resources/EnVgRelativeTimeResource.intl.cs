...
{
	/// <summary>
	/// Relative Time Units resource for 'English (British Virgin Islands)' [en-vg]
	/// </summary>
	public class EnVgRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnVgRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-vg");
		}
	}
}