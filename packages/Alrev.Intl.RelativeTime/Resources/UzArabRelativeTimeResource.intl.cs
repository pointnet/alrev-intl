...
{
	/// <summary>
	/// Relative Time Units resource for 'Uzbek' [uz-arab]
	/// </summary>
	public class UzArabRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public UzArabRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("uz-arab");
		}
	}
}