...
{
	/// <summary>
	/// Relative Time Units resource for 'English (Guam)' [en-gu]
	/// </summary>
	public class EnGuRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EnGuRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("en-gu");
		}
	}
}