...
{
	/// <summary>
	/// Relative Time Units resource for 'Ossetic' [os]
	/// </summary>
	public class OsRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("os");
		}
	}
}