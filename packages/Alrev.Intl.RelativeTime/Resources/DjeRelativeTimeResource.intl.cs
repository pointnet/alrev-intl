...
{
	/// <summary>
	/// Relative Time Units resource for 'Zarma' [dje]
	/// </summary>
	public class DjeRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public DjeRelativeTimeResource()
		...
		{
			this.Culture = new CultureInfo("dje");
		}
	}
}