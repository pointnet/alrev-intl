...
{
	/// <summary>
	/// Relative Time Units resource for 'Tamil (Sri Lanka)' [ta-lk]
	/// </summary>
	public class TaLkRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public TaLkRelativeTimeResource()
