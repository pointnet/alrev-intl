...
{
	/// <summary>
	/// Relative Time Units resource for 'Malay (Brunei)' [ms-bn]
	/// </summary>
	public class MsBnRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public MsBnRelativeTimeResource()
