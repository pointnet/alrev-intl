...
{
	/// <summary>
	/// Relative Time Units resource for 'Spanish (Guatemala)' [es-gt]
	/// </summary>
	public class EsGtRelativeTimeResource : ReadOnlyDictionary<RelativeTimeUnitValues, IReadOnlyDictionary<IntlStyleValues, IRelativeTimeResource>>, IRelativeTimeUnitsResource
	{
		/// <summary>
		...
		/// </summary>
		public EsGtRelativeTimeResource()
