...
{
	/// <summary>
	/// List resources for 'Tamil (Singapore)' [ta-sg]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class TaSgListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0} மற்றும் {1}" },
										{ ListPartValues.Pair, "{0} மற்றும் {1}" }
									})
							},
							{
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}, {1}" },
										{ ListPartValues.Middle, "{0}, {1}" },
										{ ListPartValues.End, "{0} அல்லது {1}" },
										{ ListPartValues.Pair, "{0} அல்லது {1}" }
									})
							},
							{
								IntlStyleValues.Short,
		...
		{
			this.Culture = new CultureInfo("ta-sg");
		}
	}
}