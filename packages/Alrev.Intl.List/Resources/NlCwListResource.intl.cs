...
{
	/// <summary>
	/// List resources for 'Dutch (Cura&#231;ao)' [nl-cw]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class NlCwListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("nl-cw");
		}
	}
}