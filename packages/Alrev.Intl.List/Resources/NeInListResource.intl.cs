...
{
	/// <summary>
	/// List resources for 'Nepali (India)' [ne-in]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class NeInListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0} र {1}" },
										{ ListPartValues.Pair, "{0} र {1}" }
									})
							},
							{
		...
		{
			this.Culture = new CultureInfo("ne-in");
		}
	}
}