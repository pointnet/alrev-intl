...
{
	/// <summary>
	/// List resources for 'Spanish (Dominican Republic)' [es-do]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class EsDoListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0} y {1}" },
										{ ListPartValues.Pair, "{0} y {1}" }
									})
							},
							{
		...
		{
			this.Culture = new CultureInfo("es-do");
		}
	}
}