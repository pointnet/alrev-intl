...
{
	/// <summary>
	/// List resources for 'Ngomba' [jgo]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class JgoListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									...
									{
										{ ListPartValues.Start, "{0}, ŋ́gɛ {1}" },
										{ ListPartValues.Middle, "{0}, ŋ́gɛ {1}" },
										{ ListPartValues.End, "{0}, ḿbɛn ŋ́gɛ {1}" },
										{ ListPartValues.Pair, "{0} pɔp {1}" }
									})
							},
							{
