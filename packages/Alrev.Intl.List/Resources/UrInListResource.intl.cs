...
{
	/// <summary>
	/// List resources for 'Urdu (India)' [ur-in]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class UrInListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0}، اور {1}" },
										{ ListPartValues.Pair, "{0} اور {1}" }
									})
							},
							{
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}، {1}" },
										{ ListPartValues.Middle, "{0}، {1}" },
										{ ListPartValues.End, "{0}، یا {1}" },
										{ ListPartValues.Pair, "{0} یا {1}" }
									})
							},
							{
								IntlStyleValues.Short,
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}, {1}" },
										{ ListPartValues.Middle, "{0}, {1}" },
										{ ListPartValues.End, "{1}، {0}" },
										{ ListPartValues.Pair, "{1}، {0}" }
									})
							},
							{
								IntlStyleValues.Short,
							...
							},
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{1} {0}" },
										{ ListPartValues.Middle, "{1} {0}" },
										{ ListPartValues.End, "{1} {0}" },
										{ ListPartValues.Pair, "{1} {0}" }
									})
							}
