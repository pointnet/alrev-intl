...
{
	/// <summary>
	/// List resources for 'Portuguese (Switzerland)' [pt-ch]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class PtChListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
		...
		{
			this.Culture = new CultureInfo("pt-ch");
		}
	}
}