...
{
	/// <summary>
	/// List resources for 'Slovenian' [sl]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class SlListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0} in {1}" },
										{ ListPartValues.Pair, "{0} in {1}" }
									})
							},
							{
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}, {1}" },
										{ ListPartValues.Middle, "{0}, {1}" },
										{ ListPartValues.End, "{0} ali {1}" },
										{ ListPartValues.Pair, "{0} ali {1}" }
									})
							},
							{
								IntlStyleValues.Short,
