...
{
	/// <summary>
	/// List resources for 'Chinese (Simplified, Hong Kong SAR)' [zh-hans-hk]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class ZhHansHkListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0}和{1}" },
										{ ListPartValues.Pair, "{0}和{1}" }
									})
							},
							{
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}、{1}" },
										{ ListPartValues.Middle, "{0}、{1}" },
										{ ListPartValues.End, "{0}或{1}" },
										{ ListPartValues.Pair, "{0}或{1}" }
									})
							},
							{
								IntlStyleValues.Short,
		...
		{
			this.Culture = new CultureInfo("zh-hans-hk");
		}
	}
}