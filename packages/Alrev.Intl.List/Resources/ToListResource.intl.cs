...
{
	/// <summary>
	/// List resources for 'Tongan' [to]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class ToListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									...
									{
										{ ListPartValues.Start, "{0} mo {1}" },
										{ ListPartValues.Middle, "{0} mo {1}" },
										{ ListPartValues.End, "{0} mo {1}" },
										{ ListPartValues.Pair, "{0} mo {1}" }
									})
							},
							{
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0}, pē {1}" },
										{ ListPartValues.Pair, "{0} pē {1}" }
									})
							},
							{
								IntlStyleValues.Short,
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}, {1}" },
										{ ListPartValues.Middle, "{0}, {1}" },
										{ ListPartValues.End, "{0} mo e {1}" },
										{ ListPartValues.Pair, "{0} mo e {1}" }
									})
							},
							{
								IntlStyleValues.Short,
