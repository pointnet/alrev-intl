...
{
	/// <summary>
	/// List resources for 'Malayalam' [ml]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class MlListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0}, {1} എന്നിവ" },
										{ ListPartValues.Pair, "{0} കൂടാതെ {1}" }
									})
							},
							{
							...
							},
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.Middle, "{0}, {1}" },
										{ ListPartValues.End, "{0}, {1} എന്നിവ" },
										{ ListPartValues.Pair, "{0}, {1} എന്നിവ" }
									})
							}
						})
				},
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										{ ListPartValues.Start, "{0}, {1} എന്നിവ" },
										{ ListPartValues.Middle, "{0}, {1} എന്നിവ" },
										{ ListPartValues.End, "{0}, അല്ലെങ്കിൽ {1}" },
										{ ListPartValues.Pair, "{0} അല്ലെങ്കിൽ {1}" }
									})
							},
							{
								IntlStyleValues.Short,
