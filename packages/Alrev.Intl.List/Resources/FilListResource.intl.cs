...
{
	/// <summary>
	/// List resources for 'Filipino' [fil]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class FilListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									new Dictionary<ListPartValues, string>()
									{
										...
										{ ListPartValues.End, "{0}, at {1}" },
										{ ListPartValues.Pair, "{0} at {1}" }
									})
							},
							{
		...
		{
			this.Culture = new CultureInfo("fil");
		}
	}
}