...
{
	/// <summary>
	/// List resources for 'Dzongkha' [dz]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/by_type/miscellaneous.displaying_lists.html"/>
	public class DzListResource : ReadOnlyDictionary<ListTypeValues, IReadOnlyDictionary<IntlStyleValues, IReadOnlyDictionary<ListPartValues, string>>>, IListResource
	{
		/// <summary>
						...
						{
							{
								...
								new ReadOnlyDictionary<ListPartValues, string>(
									...
									{
										{ ListPartValues.Start, "{0} དང་ {1}" },
										{ ListPartValues.Middle, "{0} དང་ {1}" },
										{ ListPartValues.End, "{0} དང་ {1}" },
										{ ListPartValues.Pair, "{0} དང་ {1}" }
									})
							},
							{
