...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Uzbek' [uz]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#uz"/>
	public class UzPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public UzPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("uz");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Uzbek' [uz] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
