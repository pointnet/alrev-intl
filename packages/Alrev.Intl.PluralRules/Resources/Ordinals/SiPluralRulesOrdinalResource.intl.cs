...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Sinhala' [si]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#si"/>
	public class SiPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SiPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("si");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Sinhala' [si] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
