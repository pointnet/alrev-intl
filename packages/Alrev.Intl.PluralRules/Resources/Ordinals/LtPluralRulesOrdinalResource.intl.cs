...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Lithuanian' [lt]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#lt"/>
	public class LtPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public LtPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("lt");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Lithuanian' [lt] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
