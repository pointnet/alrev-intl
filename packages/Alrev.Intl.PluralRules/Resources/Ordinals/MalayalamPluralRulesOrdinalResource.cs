...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Malayalam' [ml]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ml"/>
    public class MalayalamPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Malayalam' [ml] Ordinal <see cref="IPluralRulesResource"/>
        /// </summary>
