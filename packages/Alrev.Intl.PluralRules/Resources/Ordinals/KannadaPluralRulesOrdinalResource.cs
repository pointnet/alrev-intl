...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Kannada' [kn]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#kn"/>
    public class KannadaPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Kannada' [kn] Ordinal <see cref="IPluralRulesResource"/>
        /// </summary>
