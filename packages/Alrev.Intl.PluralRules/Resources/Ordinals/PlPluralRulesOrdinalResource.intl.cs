...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Polish' [pl]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#pl"/>
	public class PlPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public PlPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("pl");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Polish' [pl] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
