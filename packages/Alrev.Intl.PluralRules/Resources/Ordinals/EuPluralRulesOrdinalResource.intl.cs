...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Basque' [eu]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#eu"/>
	public class EuPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public EuPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("eu");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Basque' [eu] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
