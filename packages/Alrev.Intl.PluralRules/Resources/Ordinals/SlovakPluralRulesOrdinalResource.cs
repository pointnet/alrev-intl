...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Slovak' [sk]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sk"/>
    public class SlovakPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Slovak' [sk] Ordinal <see cref="IPluralRulesResource"/>
        /// </summary>
