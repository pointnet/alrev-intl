...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Kannada' [kn]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#kn"/>
	public class KnPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public KnPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("kn");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Kannada' [kn] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
