...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Hebrew' [he]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#he"/>
	public class HePluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public HePluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("he");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Hebrew' [he] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
