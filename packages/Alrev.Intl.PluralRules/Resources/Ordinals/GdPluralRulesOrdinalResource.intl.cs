...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Scottish Gaelic' [gd]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#gd"/>
	public class GdPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public GdPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("gd");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Scottish Gaelic' [gd] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
