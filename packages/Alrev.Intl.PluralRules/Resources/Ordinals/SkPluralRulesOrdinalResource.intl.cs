...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Slovak' [sk]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sk"/>
	public class SkPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SkPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("sk");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Slovak' [sk] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
