...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'English' [en]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#en"/>
	public class EnPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public EnPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("en");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'English' [en] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
