...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Hindi' [hi]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#hi"/>
	public class HiPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public HiPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("hi");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Hindi' [hi] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
