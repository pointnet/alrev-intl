...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Croatian' [hr]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#hr"/>
	public class HrPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public HrPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("hr");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Croatian' [hr] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
