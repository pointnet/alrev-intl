...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Spanish' [es]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#es"/>
    public class SpanishPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Spanish' [es] Ordinal <see cref="IPluralRulesResource"/>
        /// </summary>
