...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Gujarati' [gu]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#gu"/>
	public class GuPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public GuPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("gu");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Gujarati' [gu] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
