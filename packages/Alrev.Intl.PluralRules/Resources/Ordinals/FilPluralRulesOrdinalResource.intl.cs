...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Filipino' [fil]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#fil"/>
	public class FilPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public FilPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("fil");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Filipino' [fil] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
