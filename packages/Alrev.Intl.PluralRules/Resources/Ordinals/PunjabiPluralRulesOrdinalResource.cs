...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Punjabi' [pa]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#pa"/>
    public class PunjabiPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
		...
		/// <summary>
  		/// Evaluates a <see cref="IPluralRulesContext"/> against the 'Punjabi' [pa] Ordinal <see cref="IPluralRulesResource"/>
  		/// </summary>
