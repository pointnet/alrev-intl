...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Armenian' [hy]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#hy"/>
    public class ArmenianPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Armenian' [hy] Ordinal <see cref="IPluralRulesResource"/>
        /// </summary>
