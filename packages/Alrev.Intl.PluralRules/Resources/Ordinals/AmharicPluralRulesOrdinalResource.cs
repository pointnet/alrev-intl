...
{
	/// <summary>
	/// Ordinal <see cref="IPluralRulesResource"/> for 'Amharic' [am]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#am"/>
    public class AmharicPluralRulesOrdinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
		...
		/// <summary>
  		/// Evaluates a <see cref="IPluralRulesContext"/> against the 'Amharic' [am] Ordinal <see cref="IPluralRulesResource"/>
  		/// </summary>
