...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Punjabi' [pa]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#pa"/>
	public class PaPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public PaPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("pa");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Punjabi' [pa] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
