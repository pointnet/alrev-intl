...
{
	/// <summary>
	/// Plural Rules Ordinal resources for 'Kiswahili' [sw]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sw"/>
	public class SwPluralRulesOrdinalResource : IPluralRulesOrdinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SwPluralRulesOrdinalResource()
		{
			this.Culture = new CultureInfo("sw");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Kiswahili' [sw] <see cref="IPluralRulesOrdinalResource"/>
		/// </summary>
