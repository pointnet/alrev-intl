...
{
	/// <summary>
	/// Cardinal <see cref="IPluralRulesResource"/> for 'Inuktitut' [iu]
	/// </summary>
    ...
    public class InuktitutPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Inuktitut' [iu] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
