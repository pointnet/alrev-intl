...
{
	/// <summary>
	/// Cardinal <see cref="IPluralRulesResource"/> for 'Northern Sami' [se]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#se"/>
    public class NorthernSamiPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        /// The <see cref="IPluralRulesResource"/> locale
        /// </summary>
        public string Locale { get; } = "se";
		...
		/// <summary>
  		/// Evaluates a <see cref="IPluralRulesContext"/> against the 'Northern Sami' [se] Cardinal <see cref="IPluralRulesResource"/>
  		/// </summary>
