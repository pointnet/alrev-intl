...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Galician' [gl]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#gl"/>
	public class GlPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public GlPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("gl");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Galician' [gl] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
