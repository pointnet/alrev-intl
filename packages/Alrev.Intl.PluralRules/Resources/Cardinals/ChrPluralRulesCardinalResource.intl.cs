...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Cherokee' [chr]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#chr"/>
	public class ChrPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public ChrPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("chr");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Cherokee' [chr] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
