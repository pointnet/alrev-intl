...
{
    /// <summary>
    /// Cardinal <see cref="IPluralRulesResource"/> for 'Punjabi' [pa]
    /// </summary>
    /// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#pa"/>
    public class PunjabiPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        /// The <see cref="IPluralRulesResource"/> locale
        /// </summary>
        public string Locale { get; } = "pa";
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Punjabi' [pa] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
