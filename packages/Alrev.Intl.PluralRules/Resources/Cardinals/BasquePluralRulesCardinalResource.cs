...
{
	/// <summary>
	/// Cardinal <see cref="IPluralRulesResource"/> for 'Basque' [eu]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#eu"/>
    public class BasquePluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        /// The <see cref="IPluralRulesResource"/> locale
        /// </summary>
        public string Locale { get; } = "eu";
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Basque' [eu] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
