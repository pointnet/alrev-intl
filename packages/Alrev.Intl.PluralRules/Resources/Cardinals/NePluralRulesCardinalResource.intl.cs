...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Nepali' [ne]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ne"/>
	public class NePluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public NePluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ne");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Nepali' [ne] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
