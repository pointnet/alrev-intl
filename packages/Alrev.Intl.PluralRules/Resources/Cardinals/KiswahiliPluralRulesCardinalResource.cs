...
{
    /// <summary>
    /// Cardinal <see cref="IPluralRulesResource"/> for 'Kiswahili' [sw]
    /// </summary>
    /// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sw"/>
    public class KiswahiliPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        /// The <see cref="IPluralRulesResource"/> locale
        /// </summary>
        public string Locale { get; } = "sw";
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Kiswahili' [sw] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
