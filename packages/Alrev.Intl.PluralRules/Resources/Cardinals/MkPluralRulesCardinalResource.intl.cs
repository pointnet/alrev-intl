...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Macedonian' [mk]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#mk"/>
	public class MkPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public MkPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("mk");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Macedonian' [mk] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
