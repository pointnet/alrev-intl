...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Albanian' [sq]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sq"/>
	public class SqPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SqPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("sq");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Albanian' [sq] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
