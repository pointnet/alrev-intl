...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Gujarati' [gu]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#gu"/>
	public class GuPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public GuPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("gu");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Gujarati' [gu] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
