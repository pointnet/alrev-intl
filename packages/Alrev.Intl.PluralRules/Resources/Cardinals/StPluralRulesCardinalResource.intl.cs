...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Sesotho' [st]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#st"/>
	public class StPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public StPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("st");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Sesotho' [st] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
