...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Serbian' [sr]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sr"/>
	public class SrPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SrPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("sr");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Serbian' [sr] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
