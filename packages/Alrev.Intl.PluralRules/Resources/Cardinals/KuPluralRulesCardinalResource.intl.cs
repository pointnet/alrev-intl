...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Kurdish' [ku]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ku"/>
	public class KuPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public KuPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ku");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Kurdish' [ku] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
