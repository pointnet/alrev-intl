...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Bangla' [bn]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#bn"/>
	public class BnPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public BnPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("bn");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Bangla' [bn] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
