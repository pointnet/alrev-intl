...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Friulian' [fur]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#fur"/>
	public class FurPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public FurPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("fur");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Friulian' [fur] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
