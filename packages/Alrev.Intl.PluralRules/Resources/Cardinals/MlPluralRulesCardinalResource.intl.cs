...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Malayalam' [ml]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ml"/>
	public class MlPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public MlPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ml");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Malayalam' [ml] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
