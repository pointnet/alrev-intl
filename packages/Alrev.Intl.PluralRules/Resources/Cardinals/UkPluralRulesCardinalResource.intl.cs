...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Ukrainian' [uk]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#uk"/>
	public class UkPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public UkPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("uk");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Ukrainian' [uk] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
