...
{
	/// <summary>
	/// Cardinal <see cref="IPluralRulesResource"/> for 'Georgian' [ka]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ka"/>
    public class GeorgianPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Georgian' [ka] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
