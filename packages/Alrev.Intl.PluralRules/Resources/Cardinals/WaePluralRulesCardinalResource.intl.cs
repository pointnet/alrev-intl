...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Walser' [wae]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#wae"/>
	public class WaePluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public WaePluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("wae");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Walser' [wae] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
