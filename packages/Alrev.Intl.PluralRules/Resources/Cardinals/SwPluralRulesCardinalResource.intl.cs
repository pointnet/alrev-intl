...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Kiswahili' [sw]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#sw"/>
	public class SwPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SwPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("sw");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Kiswahili' [sw] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
