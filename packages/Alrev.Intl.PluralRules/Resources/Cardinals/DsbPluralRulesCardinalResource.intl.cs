...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Lower Sorbian' [dsb]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#dsb"/>
	public class DsbPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public DsbPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("dsb");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Lower Sorbian' [dsb] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
