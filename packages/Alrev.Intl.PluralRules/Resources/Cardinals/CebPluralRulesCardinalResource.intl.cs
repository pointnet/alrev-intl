...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Cebuano' [ceb]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ceb"/>
	public class CebPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public CebPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ceb");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Cebuano' [ceb] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
