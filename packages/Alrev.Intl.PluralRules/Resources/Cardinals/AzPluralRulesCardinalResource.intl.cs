...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Azerbaijani' [az]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#az"/>
	public class AzPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public AzPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("az");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Azerbaijani' [az] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
