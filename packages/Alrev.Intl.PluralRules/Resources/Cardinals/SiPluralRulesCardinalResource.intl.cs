...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Sinhala' [si]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#si"/>
	public class SiPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SiPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("si");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Sinhala' [si] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
