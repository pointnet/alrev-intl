...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Soga' [xog]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#xog"/>
	public class XogPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public XogPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("xog");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Soga' [xog] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
