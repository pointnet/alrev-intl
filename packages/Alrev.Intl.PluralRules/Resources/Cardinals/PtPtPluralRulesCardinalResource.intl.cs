...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Portuguese (Portugal)' [pt-pt]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#pt-pt"/>
	public class PtPtPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public PtPtPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("pt-pt");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Portuguese (Portugal)' [pt-pt] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
