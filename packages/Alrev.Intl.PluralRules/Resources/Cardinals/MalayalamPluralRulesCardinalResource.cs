...
{
    /// <summary>
    /// Cardinal <see cref="IPluralRulesResource"/> for 'Malayalam' [ml]
    /// </summary>
    /// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ml"/>
    public class MalayalamPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        /// The <see cref="IPluralRulesResource"/> locale
        /// </summary>
        public string Locale { get; } = "ml";
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Malayalam' [ml] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
