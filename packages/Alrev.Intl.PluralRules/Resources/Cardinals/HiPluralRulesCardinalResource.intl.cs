...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Hindi' [hi]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#hi"/>
	public class HiPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public HiPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("hi");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Hindi' [hi] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
