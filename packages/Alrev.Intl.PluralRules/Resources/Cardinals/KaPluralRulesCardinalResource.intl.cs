...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Georgian' [ka]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ka"/>
	public class KaPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public KaPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ka");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Georgian' [ka] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
