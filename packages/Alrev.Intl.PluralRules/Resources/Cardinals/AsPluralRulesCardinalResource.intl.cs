...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Assamese' [as]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#as"/>
	public class AsPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public AsPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("as");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Assamese' [as] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
