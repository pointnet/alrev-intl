...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Filipino' [fil]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#fil"/>
	public class FilPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public FilPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("fil");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Filipino' [fil] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
