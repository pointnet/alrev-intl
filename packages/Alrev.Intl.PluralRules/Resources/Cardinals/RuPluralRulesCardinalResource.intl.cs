...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Russian' [ru]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ru"/>
	public class RuPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public RuPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ru");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Russian' [ru] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
