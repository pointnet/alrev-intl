...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Central Atlas Tamazight' [tzm]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#tzm"/>
	public class TzmPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public TzmPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("tzm");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Central Atlas Tamazight' [tzm] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
