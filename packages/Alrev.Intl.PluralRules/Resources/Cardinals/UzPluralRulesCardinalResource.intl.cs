...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Uzbek' [uz]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#uz"/>
	public class UzPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public UzPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("uz");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Uzbek' [uz] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
