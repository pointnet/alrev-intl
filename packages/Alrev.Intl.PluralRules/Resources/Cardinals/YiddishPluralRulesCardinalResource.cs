...
{
    /// <summary>
    /// Cardinal <see cref="IPluralRulesResource"/> for 'Yiddish' [yi]
    /// </summary>
    /// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#yi"/>
    public class YiddishPluralRulesCardinalResource : IPluralRulesResource, IResource
    {
        /// <summary>
        /// The <see cref="IPluralRulesResource"/> locale
        /// </summary>
        public string Locale { get; } = "yi";
        ...
        /// <summary>
        /// Evaluates a <see cref="IPluralRulesContext"/> against the 'Yiddish' [yi] Cardinal <see cref="IPluralRulesResource"/>
        /// </summary>
