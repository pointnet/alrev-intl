...
{
	/// <summary>
	/// Cardinal <see cref="IPluralRulesResource"/> for 'Tigre' [tig]
	/// </summary>
    ...
    public class TigrePluralRulesCardinalResource : IPluralRulesResource, IResource
    {
		...
		/// <summary>
  		/// Evaluates a <see cref="IPluralRulesContext"/> against the 'Tigre' [tig] Cardinal <see cref="IPluralRulesResource"/>
  		/// </summary>
