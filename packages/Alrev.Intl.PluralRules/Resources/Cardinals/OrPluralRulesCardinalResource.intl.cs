...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Odia' [or]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#or"/>
	public class OrPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public OrPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("or");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Odia' [or] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
