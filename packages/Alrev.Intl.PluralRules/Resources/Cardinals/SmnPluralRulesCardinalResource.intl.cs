...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Inari Sami' [smn]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#smn"/>
	public class SmnPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public SmnPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("smn");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Inari Sami' [smn] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
