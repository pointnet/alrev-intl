...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Romanian' [ro]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#ro"/>
	public class RoPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public RoPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("ro");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Romanian' [ro] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
