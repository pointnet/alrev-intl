...
{
	/// <summary>
	/// Plural Rules Cardinal resources for 'Bosnian' [bs]
	/// </summary>
	/// <seealso href="https://unicode-org.github.io/cldr-staging/charts/39/supplemental/language_plural_rules.html#bs"/>
	public class BsPluralRulesCardinalResource : IPluralRulesCardinalResource
	{
		/// <summary>
		...
		/// </summary>
		public BsPluralRulesCardinalResource()
		{
			this.Culture = new CultureInfo("bs");
		}

		/// <summary>
		/// Evaluates an <see cref="IPluralRulesContext"/> against the 'Bosnian' [bs] <see cref="IPluralRulesCardinalResource"/>
		/// </summary>
