...
namespace Alrev.Intl.PluralRules.Tests.Resources.Ordinals
{
	...
	public class SvPluralRulesOrdinalResourceTests
	{
		private PluralRulesOrdinalResourceLocalizerFixture Fixture { get; }

		public SvPluralRulesOrdinalResourceTests(PluralRulesOrdinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("sv");
