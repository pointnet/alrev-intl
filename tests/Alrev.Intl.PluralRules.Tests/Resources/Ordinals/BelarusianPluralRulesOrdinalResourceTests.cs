...
namespace Alrev.Intl.PluralRules.Tests.Resources.Ordinals
{
    ...
    public class BelarusianPluralRulesOrdinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public BelarusianPluralRulesOrdinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        [InlineData("72", PluralRulesValues.Few)]
        [InlineData("73", PluralRulesValues.Few)]
        [InlineData("82", PluralRulesValues.Few)]
