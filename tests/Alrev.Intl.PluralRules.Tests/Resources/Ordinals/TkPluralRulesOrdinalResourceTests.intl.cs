...
namespace Alrev.Intl.PluralRules.Tests.Resources.Ordinals
{
	...
	public class TkPluralRulesOrdinalResourceTests
	{
		private PluralRulesOrdinalResourceLocalizerFixture Fixture { get; }

		public TkPluralRulesOrdinalResourceTests(PluralRulesOrdinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("tk");
		...
		[InlineData("36", PluralRulesValues.Few)]
		[InlineData("39", PluralRulesValues.Few)]
		[InlineData("106", PluralRulesValues.Few)]
		[InlineData("1006", PluralRulesValues.Few)]
