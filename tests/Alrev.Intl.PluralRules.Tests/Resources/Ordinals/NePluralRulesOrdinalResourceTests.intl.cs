...
namespace Alrev.Intl.PluralRules.Tests.Resources.Ordinals
{
	...
	public class NePluralRulesOrdinalResourceTests
	{
		private PluralRulesOrdinalResourceLocalizerFixture Fixture { get; }

		public NePluralRulesOrdinalResourceTests(PluralRulesOrdinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("ne");
