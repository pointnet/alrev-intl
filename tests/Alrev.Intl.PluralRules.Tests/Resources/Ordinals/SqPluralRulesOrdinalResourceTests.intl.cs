...
namespace Alrev.Intl.PluralRules.Tests.Resources.Ordinals
{
	...
	public class SqPluralRulesOrdinalResourceTests
	{
		private PluralRulesOrdinalResourceLocalizerFixture Fixture { get; }

		public SqPluralRulesOrdinalResourceTests(PluralRulesOrdinalResourceLocalizerFixture fixture)	
		{
		...
		[InlineData("34", PluralRulesValues.Many)]
		[InlineData("44", PluralRulesValues.Many)]
		[InlineData("54", PluralRulesValues.Many)]
		[InlineData("64", PluralRulesValues.Many)]
		[InlineData("74", PluralRulesValues.Many)]
		[InlineData("84", PluralRulesValues.Many)]
		[InlineData("104", PluralRulesValues.Many)]
		[InlineData("1004", PluralRulesValues.Many)]
