...
namespace Alrev.Intl.PluralRules.Tests.Resources.Ordinals
{
	...
	public class BnPluralRulesOrdinalResourceTests
	{
		private PluralRulesOrdinalResourceLocalizerFixture Fixture { get; }

		public BnPluralRulesOrdinalResourceTests(PluralRulesOrdinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("bn");
