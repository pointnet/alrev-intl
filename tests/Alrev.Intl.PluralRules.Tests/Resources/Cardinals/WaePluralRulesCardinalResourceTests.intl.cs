...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class WaePluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public WaePluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("wae");
