...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class WesternFrisianPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public WesternFrisianPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("fy");
