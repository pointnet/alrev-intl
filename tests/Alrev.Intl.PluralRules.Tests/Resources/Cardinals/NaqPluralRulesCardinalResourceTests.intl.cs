...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class NaqPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public NaqPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("naq");
