...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class NorthNdebelePluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public NorthNdebelePluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("nd");
