...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class AsaPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public AsaPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("asa");
