...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class SmjPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public SmjPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("smj");
