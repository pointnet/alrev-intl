...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class RwkPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public RwkPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("rwk");
