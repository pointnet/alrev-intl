...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class SwissGermanPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public SwissGermanPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("gsw");
