...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class SouthernSamiPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public SouthernSamiPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("sma");
