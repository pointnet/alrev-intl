...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class IsPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public IsPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("is");
		...
		[InlineData("1.6", PluralRulesValues.One)]
		...
		[InlineData("3.0", PluralRulesValues.Other)]
		[InlineData("4.0", PluralRulesValues.Other)]
		[InlineData("5.0", PluralRulesValues.Other)]
		[InlineData("6.0", PluralRulesValues.Other)]
		[InlineData("7.0", PluralRulesValues.Other)]
		[InlineData("8.0", PluralRulesValues.Other)]
