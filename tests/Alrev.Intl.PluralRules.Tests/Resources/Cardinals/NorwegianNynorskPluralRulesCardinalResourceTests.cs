...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class NorwegianNynorskPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public NorwegianNynorskPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("nn");
