...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class NnhPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public NnhPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("nnh");
