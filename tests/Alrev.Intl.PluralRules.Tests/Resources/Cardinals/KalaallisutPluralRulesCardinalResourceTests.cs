...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class KalaallisutPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public KalaallisutPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("kl");
