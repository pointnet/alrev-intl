...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class SesothosaLeboaPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public SesothosaLeboaPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("nso");
