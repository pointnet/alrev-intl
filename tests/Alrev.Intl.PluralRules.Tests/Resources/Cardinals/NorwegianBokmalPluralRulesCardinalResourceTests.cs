...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class NorwegianBokmalPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public NorwegianBokmalPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("nb");
