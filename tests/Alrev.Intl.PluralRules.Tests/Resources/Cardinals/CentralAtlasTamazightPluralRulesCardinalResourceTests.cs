...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class CentralAtlasTamazightPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public CentralAtlasTamazightPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
