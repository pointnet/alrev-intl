...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class InterlinguaPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public InterlinguaPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("ia");
