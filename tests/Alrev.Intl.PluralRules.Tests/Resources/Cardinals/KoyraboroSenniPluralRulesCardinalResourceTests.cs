...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class KoyraboroSenniPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public KoyraboroSenniPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("ses");
