...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class BamanankanPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public BamanankanPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("bm");
