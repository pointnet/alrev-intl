...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class LuxembourgishPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public LuxembourgishPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("lb");
