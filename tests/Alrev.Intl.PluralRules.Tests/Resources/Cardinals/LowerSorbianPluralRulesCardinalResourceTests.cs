...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class LowerSorbianPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public LowerSorbianPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("dsb");
