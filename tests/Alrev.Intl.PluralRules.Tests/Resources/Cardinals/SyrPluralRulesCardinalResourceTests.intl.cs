...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class SyrPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public SyrPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("syr");
