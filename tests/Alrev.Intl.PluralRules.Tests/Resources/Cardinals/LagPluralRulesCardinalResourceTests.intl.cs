...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class LagPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public LagPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("lag");
		...
		[InlineData("3.5", PluralRulesValues.Other)]
