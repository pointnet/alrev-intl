...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class KdePluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public KdePluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("kde");
