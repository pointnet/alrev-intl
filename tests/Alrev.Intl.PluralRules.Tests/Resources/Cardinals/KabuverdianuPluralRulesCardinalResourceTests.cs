...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
    ...
    public class KabuverdianuPluralRulesCardinalResourceTests
    {
        private PluralRulesLocalizersFixture fixture;

        public KabuverdianuPluralRulesCardinalResourceTests(PluralRulesLocalizersFixture fixture)
        {
        ...
        {
            CultureInfo culture = new CultureInfo("kea");
