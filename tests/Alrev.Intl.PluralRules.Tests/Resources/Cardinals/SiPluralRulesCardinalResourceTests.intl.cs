...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class SiPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public SiPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("si");
		...
		[InlineData("1.8", PluralRulesValues.Other)]
