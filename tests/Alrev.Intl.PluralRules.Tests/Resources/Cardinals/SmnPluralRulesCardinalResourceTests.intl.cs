...
namespace Alrev.Intl.PluralRules.Tests.Resources.Cardinals
{
	...
	public class SmnPluralRulesCardinalResourceTests
	{
		private PluralRulesCardinalResourceLocalizerFixture Fixture { get; }

		public SmnPluralRulesCardinalResourceTests(PluralRulesCardinalResourceLocalizerFixture fixture)	
		{
		...
		{
			CultureInfo culture = new CultureInfo("smn");
