...
namespace Alrev.Intl.RelativeTime.Tests.Globalization
{
    ...
    public class RelativeTimeLocalizerTests
    {
        ...
        {
            bool supported = this.fixture.Localizer.IsSupported(new CultureInfo("aa"));
        ...
        {
            bool supported = this.fixture.Localizer.IsSupported(new CultureInfo("aa-DJ"));
            Assert.False(supported);
        }
        ...
        {
            bool supported = this.fixture.Localizer.IsSupported(new CultureInfo("en"));
        ...
        {
            bool supported = this.fixture.Localizer.IsSupported(new CultureInfo("en-US"));
            Assert.True(supported);
        }
    }
}