...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class NorthernSamiSwedenRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public NorthernSamiSwedenRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("se-se"));
        ...
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Long, "jáhki", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Narrow, "jáhki", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Short, "jáhki", 3, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Narrow, "mánnu", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Short, "mánnu", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Long, "váhkku", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Narrow, "váhkku", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Short, "váhkku", 3, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Narrow, "beaivi", 5, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Short, "beaivi", 5, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Long, "váhkkubeaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Narrow, "váhkkubeaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Short, "váhkkubeaivi", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Long, "beaivi ráidodássi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Narrow, "beaivi ráidodássi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Short, "beaivi ráidodássi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Long, "diibmu", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Narrow, "diibmu", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Short, "diibmu", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Long, "minuhtta", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Narrow, "minuhtta", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Short, "minuhtta", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Long, "sekunda", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Narrow, "sekunda", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Short, "sekunda", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Long, "áigeavádat", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Narrow, "áigeavádat", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Short, "áigeavádat", 0, 0, 0)]
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("se-se", (resource as IResource).Locale);
