...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class NgiemboonRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public NgiemboonRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("nnh"));
        ...
        [Theory]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Long, "tsɔ́ fʉ̀ʼ", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Narrow, "tsɔ́ fʉ̀ʼ", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Short, "tsɔ́ fʉ̀ʼ", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Long, "ngùʼ", 3, 1, 1)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Narrow, "ngùʼ", 3, 1, 1)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Short, "ngùʼ", 3, 1, 1)]
        ...
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Long, "lyɛ̌ʼ", 3, 1, 1)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Narrow, "lyɛ̌ʼ", 3, 1, 1)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Short, "lyɛ̌ʼ", 3, 1, 1)]
        ...
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Long, "ngàba láʼ", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Narrow, "ngàba láʼ", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Short, "ngàba láʼ", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Long, "fʉ̀ʼ nèm", 1, 1, 1)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Narrow, "fʉ̀ʼ nèm", 1, 1, 1)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Short, "fʉ̀ʼ nèm", 1, 1, 1)]
        ...
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("nnh", (resource as IResource).Locale);
