...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class KiswahiliCongoDRCRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public KiswahiliCongoDRCRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("sw-cd"));
        ...
        [Theory]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Long, "Wakati", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Long, "Juma", 3, 2, 2)]
        ...
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Long, "Siku ya juma", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Long, "Muda wa siku", 0, 0, 0)]
        ...
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("sw-cd", (resource as IResource).Locale);
