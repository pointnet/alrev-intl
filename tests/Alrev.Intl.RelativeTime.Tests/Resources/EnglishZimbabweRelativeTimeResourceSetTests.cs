...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class EnglishZimbabweRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public EnglishZimbabweRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("en-zw"));
        ...
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("en-zw", (resource as IResource).Locale);
