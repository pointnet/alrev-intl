...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class ArabicUnitedArabEmiratesRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public ArabicUnitedArabEmiratesRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("ar-ae"));
        ...
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("ar-ae", (resource as IResource).Locale);
