...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class NorthernSamiFinlandRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public NorthernSamiFinlandRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("se-fi"));
        ...
        [Theory]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Long, "áigodat", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Narrow, "áig.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Short, "áig.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Long, "jahki", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Narrow, "j.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Short, "j.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Quarter, RelativeTimeStyleValues.Long, "njealjádasjahki", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Quarter, RelativeTimeStyleValues.Narrow, "jahkenjealjádas", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Quarter, RelativeTimeStyleValues.Short, "njealj.j.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Long, "mánnu", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Narrow, "m.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Short, "m.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Long, "vahkku", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Narrow, "v(k)", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Short, "v(k)", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.WeekOfMonth, RelativeTimeStyleValues.Long, "mánu vahkku", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekOfMonth, RelativeTimeStyleValues.Narrow, "m. v(k)", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekOfMonth, RelativeTimeStyleValues.Short, "m. v(k)", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Long, "beaivi", 5, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Narrow, "b.", 5, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Short, "b.", 5, 3, 3)]
        [InlineData(RelativeTimeUnitValues.DayOfYear, RelativeTimeStyleValues.Long, "jagi beaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayOfYear, RelativeTimeStyleValues.Narrow, "j. beaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayOfYear, RelativeTimeStyleValues.Short, "j. beaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Long, "vahkkobeaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Narrow, "v(k) beaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Short, "v(k) beaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekdayOfMonth, RelativeTimeStyleValues.Long, "mánu vahkkobeaivi", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekdayOfMonth, RelativeTimeStyleValues.Narrow, "m. v(k)b.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekdayOfMonth, RelativeTimeStyleValues.Short, "m. v(k)b.", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Long, "ib/eb", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Narrow, "ib/eb", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Short, "ib/eb", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Long, "diibmu", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Narrow, "dmu", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Short, "dmu", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Long, "minuhtta", 1, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Narrow, "sek.", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Short, "sek.", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Long, "áigeavádat", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Narrow, "á.av.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Short, "á.av.", 0, 0, 0)]
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("se-fi", (resource as IResource).Locale);
