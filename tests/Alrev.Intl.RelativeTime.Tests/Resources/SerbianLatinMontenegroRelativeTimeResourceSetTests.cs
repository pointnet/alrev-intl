...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class SerbianLatinMontenegroRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public SerbianLatinMontenegroRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("sr-latn-me"));
        ...
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Short, "god.", 3, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Long, "mesec", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Narrow, "m.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Short, "mes.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Long, "nedelja", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Narrow, "n.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Short, "ned.", 3, 3, 3)]
        [InlineData(RelativeTimeUnitValues.WeekOfMonth, RelativeTimeStyleValues.Long, "nedelja u mesecu", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekOfMonth, RelativeTimeStyleValues.Narrow, "ned. u mes.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekOfMonth, RelativeTimeStyleValues.Short, "ned. u mes.", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.DayOfYear, RelativeTimeStyleValues.Narrow, "dan u god.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayOfYear, RelativeTimeStyleValues.Short, "dan u god.", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Long, "dan u nedelji", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Narrow, "dan u nedelji", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Short, "dan u nedelji", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekdayOfMonth, RelativeTimeStyleValues.Long, "dan u mesecu", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekdayOfMonth, RelativeTimeStyleValues.Narrow, "dan u mesecu", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.WeekdayOfMonth, RelativeTimeStyleValues.Short, "dan u mesecu", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Long, "pre podne/po podne", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Narrow, "pre podne/po podne", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.DayPeriod, RelativeTimeStyleValues.Short, "pre podne/po podne", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Long, "sat", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Narrow, "č.", 1, 3, 3)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Short, "č.", 1, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Long, "sekund", 1, 3, 3)]
        ...
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Narrow, "vremenska zona", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Short, "vremenska zona", 0, 0, 0)]
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("sr-latn-me", (resource as IResource).Locale);
