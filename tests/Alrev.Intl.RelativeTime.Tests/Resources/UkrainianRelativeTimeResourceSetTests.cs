...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class UkrainianRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public UkrainianRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Long, "місяць", 3, 4, 4)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Narrow, "м", 3, 4, 4)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Short, "міс.", 3, 4, 4)]
        ...
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Long, "хвилина", 1, 4, 4)]
        ...
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("uk", (resource as IResource).Locale);
