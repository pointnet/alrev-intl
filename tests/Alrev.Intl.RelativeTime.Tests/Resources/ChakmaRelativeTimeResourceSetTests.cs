...
namespace Alrev.Intl.RelativeTime.Tests.Resources.Tests.Resources
{
    ...
    public class ChakmaRelativeTimeResourceSetTests
    {
        private RelativeTimeLocalizerFixture fixture;

        public ChakmaRelativeTimeResourceSetTests(RelativeTimeLocalizerFixture fixture)
        {
        ...
        {
            IRelativeTimeResourceSet resourceSet = this.fixture.Localizer.GetLocalizer(new CultureInfo("ccp"));
        ...
        [Theory]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Long, "𑄡𑄪𑄇𑄴", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Narrow, "𑄡𑄪𑄇𑄴", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Era, RelativeTimeStyleValues.Short, "𑄡𑄪𑄇𑄴", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Long, "𑄝𑄧𑄏𑄧𑄢𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Narrow, "𑄝𑄧𑄏𑄧𑄢𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Year, RelativeTimeStyleValues.Short, "𑄝𑄧𑄏𑄧𑄢𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Quarter, RelativeTimeStyleValues.Long, "𑄖𑄨𑄚𑄴𑄟𑄏𑄧𑄢𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Quarter, RelativeTimeStyleValues.Narrow, "𑄖𑄨𑄚𑄴𑄟𑄏𑄧𑄢𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Quarter, RelativeTimeStyleValues.Short, "𑄖𑄨𑄚𑄴𑄟𑄏𑄧𑄢𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Long, "𑄟𑄏𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Narrow, "𑄟𑄏𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Month, RelativeTimeStyleValues.Short, "𑄟𑄏𑄴", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Long, "𑄥𑄛𑄴𑄖", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Narrow, "𑄥𑄛𑄴𑄖", 3, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Week, RelativeTimeStyleValues.Short, "𑄥𑄛𑄴𑄖", 3, 2, 2)]
        ...
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Long, "𑄘𑄨𑄚𑄴", 5, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Narrow, "𑄘𑄨𑄚𑄴", 5, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Day, RelativeTimeStyleValues.Short, "𑄘𑄨𑄚𑄴", 5, 2, 2)]
        ...
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Long, "𑄥𑄛𑄴𑄖𑄢𑄴 𑄘𑄨𑄚𑄴", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Narrow, "𑄥𑄛𑄴𑄖𑄢𑄴 𑄘𑄨𑄚𑄴", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Weekday, RelativeTimeStyleValues.Short, "𑄥𑄛𑄴𑄖𑄢𑄴 𑄘𑄨𑄚𑄴", 0, 0, 0)]
        ...
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Long, "𑄊𑄮𑄚𑄴𑄓", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Narrow, "𑄊𑄮𑄚𑄴𑄓", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Hour, RelativeTimeStyleValues.Short, "𑄊𑄮𑄚𑄴𑄓", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Long, "𑄟𑄨𑄚𑄨𑄖𑄴", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Narrow, "𑄟𑄨𑄚𑄨𑄖𑄴", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Minute, RelativeTimeStyleValues.Short, "𑄟𑄨𑄚𑄨𑄖𑄴", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Long, "𑄥𑄬𑄉𑄬𑄚𑄴", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Narrow, "𑄥𑄬𑄉𑄬𑄚𑄴", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Second, RelativeTimeStyleValues.Short, "𑄥𑄬𑄉𑄬𑄚𑄴", 1, 2, 2)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Long, "𑄃𑄧𑄇𑄴𑄖𑄧𑄢𑄴 𑄎𑄉", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Narrow, "𑄃𑄧𑄇𑄴𑄖𑄧𑄢𑄴 𑄎𑄉", 0, 0, 0)]
        [InlineData(RelativeTimeUnitValues.Zone, RelativeTimeStyleValues.Short, "𑄃𑄧𑄇𑄴𑄖𑄧𑄢𑄴 𑄎𑄉", 0, 0, 0)]
        public void SpecificUnitAndStyle_ShouldReturn_ExpectedDisplayName(RelativeTimeUnitValues unit, RelativeTimeStyleValues style, string displayName, int current, int past, int future)
        {
            ...
            Assert.Equal("ccp", (resource as IResource).Locale);
